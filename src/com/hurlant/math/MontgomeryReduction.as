package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1838 = param1.invDigit();
         this.var_1839 = this.var_1838 & 32767;
         this.var_2559 = this.var_1838 >> 15;
         this.var_2560 = 131071;
         this.var_2561 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_177) > 0)
         {
