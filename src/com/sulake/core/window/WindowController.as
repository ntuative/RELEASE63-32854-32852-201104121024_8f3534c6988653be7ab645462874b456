package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1300:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1262:String = "_COLORIZE";
      
      protected static const const_1263:String = "_IGNORE_INHERITED_STYLE";
      ...
      protected var var_702:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_395 = new Rectangle();
         if(_loc12_ != null)
         {
            var_399 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_63 = var_399.clone();
            var_11 = var_399.clone();
         ...
         if(_loc13_)
         {
            var_847 = _loc13_.blend;
            var_470 = _loc13_.var_2872;
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_102);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_102,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_102,true);
                  }
                  _loc3_++;
               }
            }
      ...
      {
         return this.var_702 != null ? this.var_702 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_469 = param1;
         var_240 = !!var_469 ? uint(var_240 | var_566) : uint(var_240 & 16777215);
      ...
      {
         var_566 = param1 & 4278190080;
         var_240 = !!var_469 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_566 = param1 << 24;
         var_240 = !!var_469 ? uint(var_566 | var_240) : uint(16777215 & var_240);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      
      public function set blend(param1:Number) : void
      {
         var_847 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1140);
      }
      ...
      {
         var_470 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_763);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_79)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1263) == -1)
               {
                  _loc4_.style = var_79;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_395 = this._parent.rectangle.clone();
               var_63.x = var_11.x;
               var_63.y = var_11.y;
               var_63.width = var_11.width;
               var_63.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_882,this,this._parent);
            ...
            else
            {
               this.var_395.x = 0;
               this.var_395.y = 0;
               this.var_395.width = 0;
               this.var_395.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1558,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_20,_context,var_11,null,this.var_702,this.properties,var_864.concat(),_id) as WindowController;
         _loc2_.var_470 = var_470;
         _loc2_.var_173 = this.var_173;
         _loc2_._debug = this._debug;
         _loc2_.var_395 = this.var_395.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_399 = var_399.clone();
         ...
         _loc2_.var_566 = var_566;
         _loc2_.var_692 = var_692;
         _loc2_.var_302 = var_302;
         _loc2_.var_847 = var_847;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2858 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_479)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_522)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1110,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_226,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = 0;
         if(!testParamFlag(WindowParam.const_731))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1216;
                  if(testParamFlag(WindowParam.const_359))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_249))
                        {
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_328))
                        {
               ...
               case WindowMouseEvent.const_56:
                  ...
                  if(testParamFlag(WindowParam.const_328))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_39:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1215,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_185,WindowParam.const_178))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_188,WindowParam.const_172))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_20 = _loc6_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_140,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_226:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_1240);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1736,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_209,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_596:
                  if(param1 == this)
                  {
                     ...
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_334,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_882:
                  if(testParamFlag(WindowParam.const_185,WindowParam.const_178))
                  {
                     this.updateScaleRelativeToParent();
                  }
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_1215:
                  this._parent.getRegionProperties(null,this.var_395);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_470);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_470);
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_79 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1263) == -1)
               {
                  _loc6_.style = var_79;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_178);
         var _loc2_:* = !testParamFlag(WindowParam.const_144,WindowParam.const_172);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_395.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_372)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_395.height;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_286)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_234)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      public function destroy() : Boolean
      {
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_335,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1661,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1547,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_596,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1464,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1703,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_66,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1581,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1596,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_66,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1700,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_693,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1577,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1622,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1299 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_504,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1299 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_504,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_389,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
