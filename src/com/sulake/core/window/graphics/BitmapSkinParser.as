package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_104:String = "PlaceholderWidgetHandler";
      
      public static const const_111:String = "active";
      
      public static const const_84:String = "focused";
      
      public static const const_97:String = "hovering";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_398 = SkinLayoutEntity.const_461;
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_327;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_535;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_338;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1139;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_396 = SkinLayoutEntity.const_461;
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_327;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_535;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_338;
                  break;
               case "center":
                  _loc5_.var_396 = SkinLayoutEntity.const_1139;
            }
         }
