package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1892:uint = 64;
      
      public static const const_1816:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_575:uint = 0;
      
      protected static var var_335:uint = 0;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_194)
            {
               this.var_194 = new Shape();
               this.var_194.visible = false;
               this.var_194.cacheAsBitmap = true;
               super.addChild(this.var_194);
            }
            this.var_194.graphics.clear();
            this.var_194.graphics.beginFill(255);
            this.var_194.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_194.graphics.endFill();
            this.getDisplayObject().mask = this.var_194;
         }
         else if(this.var_194)
         {
            super.removeChild(this.var_194);
            this.var_194.graphics.clear();
            this.var_194 = null;
         ...
         if(this.var_868)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_335 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2110,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2110,16777215);
                  }
                  var_335 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_868)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_335 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
