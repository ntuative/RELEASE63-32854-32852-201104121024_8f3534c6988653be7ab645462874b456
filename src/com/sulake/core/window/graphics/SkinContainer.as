package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1331:String = "skin";
      
      private static const const_1334:String = "bitmap";
      
      private static const const_1329:String = "fill";
      
      private static const const_1330:String = "text";
      
      private static const const_1333:String = "label";
      
      private static const const_1332:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "TeleportErrorHandler";
      ...
      private var var_931:Dictionary;
      
      private var var_416:Dictionary;
      
      private var var_1732:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_931 = new Dictionary();
         this.var_1732 = new Dictionary();
         this.var_2367 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1732,this.var_2367);
         this.var_2365 = new Dictionary();
         this.var_2366 = new Dictionary();
         StateCodeTable.fillTables(this.var_2365,this.var_2366);
         this.var_416 = new Dictionary();
         this.var_416[const_1331] = BitmapSkinRenderer;
         this.var_416[const_1334] = BitmapDataRenderer;
         this.var_416[const_1329] = FillSkinRenderer;
         this.var_416[const_1330] = TextSkinRenderer;
         this.var_416[const_1333] = LabelRenderer;
         this.var_416[const_1332] = ShapeSkinRenderer;
         this.var_416[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_416[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334.push(WindowState.const_66);
            var_334.push(WindowState.const_85);
            var_334.push(WindowState.const_98);
            var_334.push(WindowState.const_55);
            var_334.push(WindowState.const_97);
            var_334.push(WindowState.const_84);
            var_334.push(WindowState.const_111);
            var_334.push(WindowState.const_104);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2872 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1732[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_930[param1] == null)
         {
            this.var_930[param1] = new Array(const_972);
         }
         this.var_930[param1][param2] = param3;
         if(this.var_931[param1] == null)
         {
            this.var_931[param1] = new Array(const_972);
         }
         this.var_931[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_211)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_931[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_211)
