package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1143:String = "_EXCLUDE";
      
      public static const const_2012:String = "_INCLUDE";
      
      public static const const_1914:String = "_TEMP";
      
      private static const const_1435:String = "layout";
      
      private static const const_1018:String = "window";
      
      private static const const_1019:String = "variables";
      
      private static const const_1017:String = "filters";
      
      private static const const_434:String = "name";
      
      private static const const_1438:String = "style";
      
      private static const const_645:String = "params";
      
      private static const const_1433:String = "tags";
      ...
      private static const const_1442:String = "visible";
      
      private static const const_1441:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1140:String = "blend";
      
      private static const const_1440:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1432:String = "treshold";
      
      private static const const_1436:String = "children";
      
      private static const const_1444:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1443:String = "height_min";
      
      private static const const_1439:String = "height_max";
      
      private static const const_646:String = "true";
      
      private static const const_177:String = "0";
      
      private static const const_1434:String = "$";
      
      private static const const_1304:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1437:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1431:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1322:Dictionary;
      
      protected var var_1321:Dictionary;
      
      protected var var_1071:Dictionary;
      
      protected var var_1593:Dictionary;
      
      protected var var_2113:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1322 = new Dictionary();
         this.var_1321 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1322,this.var_1321);
         this.var_1071 = new Dictionary();
         this.var_1593 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1071,this.var_1593);
         this.var_2113 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1431,const_49);
         return param1.replace(const_1437,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1322)
            {
               delete this.var_1322[_loc1_];
            }
            for(_loc1_ in this.var_1321)
            {
               delete this.var_1321[_loc1_];
            }
            for(_loc1_ in this.var_1071)
            {
               delete this.var_1071[_loc1_];
            }
            for(_loc1_ in this.var_1593)
            {
               delete this.var_1593[_loc1_];
            }
            this.var_2113.dispose();
            this.var_2113 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1435)
         {
            _loc8_ = param1.child(const_1019);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1017).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1018);
         ...
         if(param1.localName() == const_1018)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1322[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_434,variables,"")));
         style = uint(this.parseAttribute(xml,const_1438,variables,style));
         params = uint(this.parseAttribute(xml,const_645,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1433,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_177));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_177));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_177));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_177));
         visible = this.parseAttribute(xml,const_1442,variables,visible.toString()) == const_646;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_645).length() > 0)
         {
            list = xml.child(const_645).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_434,variables,"") as String;
               if(this.var_1071[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_434)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1441,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1304);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1019)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1444,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1443,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1439,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_646;
         blend = Number(this.parseAttribute(xml,const_1140,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1440,variables,window.clipping.toString()) == const_646;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1432,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1017).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1321[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1143) == -1)
                  {
