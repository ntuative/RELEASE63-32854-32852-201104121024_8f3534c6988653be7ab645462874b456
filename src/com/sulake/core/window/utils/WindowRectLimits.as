package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_295 = param1;
         if(this.var_295 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_295)
         {
            this._target.width = this.var_295;
         }
      }
      ...
      {
         return this.var_295 == int.MIN_VALUE && this.var_293 == int.MAX_VALUE && this.var_292 == int.MIN_VALUE && this.var_294 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_295)
            {
               this._target.width = this.var_295;
            }
