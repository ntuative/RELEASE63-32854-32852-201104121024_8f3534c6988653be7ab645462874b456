package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_399:Rectangle;
      ...
      protected var var_469:Boolean = false;
      
      protected var var_240:uint = 16777215;
      
      protected var var_566:uint;
      
      protected var var_470:uint = 10;
      
      protected var var_692:Boolean = true;
      
      protected var var_302:Boolean = true;
      
      protected var var_847:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_79 = param4;
         this.var_864 = param8 == null ? new Array() : param8;
         this._context = param6;
         this.var_11 = param7.clone();
         this.var_399 = param7.clone();
      ...
      {
         return this.var_399.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_399.height;
      }
