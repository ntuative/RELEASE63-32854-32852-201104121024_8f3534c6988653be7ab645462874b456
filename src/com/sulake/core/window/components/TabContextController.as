package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1445:String = "_SELECTOR";
      
      private static const const_1446:String = "_CONTENT";
       
      
      protected var var_1072:ITabSelectorWindow;
      
      protected var var_2114:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1072 = findChildByTag(const_1445) as ITabSelectorWindow;
            if(this.var_1072 != null)
            {
               this.var_1072.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2114 == null)
         {
            this.var_2114 = findChildByTag(const_1446) as IWindowContainer;
         }
      ...
      {
         return !!this.var_706 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1072.numSelectables;
      }
