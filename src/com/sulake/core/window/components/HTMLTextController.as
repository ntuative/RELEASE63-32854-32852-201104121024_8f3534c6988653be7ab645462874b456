package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_926:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_927:String = "PlaceholderWidgetHandler";
      
      private var var_1142:String = null;
      
      private var var_1726:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1142 == param2)
         {
            return;
         }
         param1.var_1142 = param2;
         param1.var_1726 = null;
         if(param1.var_1142 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1142);
            param1.var_1726 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_792.indexOf(param1) > -1)
         {
            this.var_927 = param1;
         }
      }
      ...
      {
         return this.var_927 == LinkTarget.const_29 ? defaultLinkTarget : this.var_927;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1726;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_927 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_662,this.var_927,PropertyStruct.const_53,true,PropertyDefaults.const_792));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1704);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_662)
            {
               this.var_927 = _loc2_.value as String;
               break;
            }
