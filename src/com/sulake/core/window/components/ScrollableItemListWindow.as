package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1197:IItemListWindow;
      
      private var var_435:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_435)
         {
            this.var_435.removeEventListener(WindowEvent.const_262,this.scrollBarEventProc);
            this.var_435.removeEventListener(WindowEvent.const_186,this.scrollBarEventProc);
            this.var_435 = null;
         }
         if(this.var_1197)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1197)
         {
            this.var_1197 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_435)
         {
            this.var_435 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_435)
            {
               this.var_435.addEventListener(WindowEvent.const_262,this.scrollBarEventProc);
               this.var_435.addEventListener(WindowEvent.const_186,this.scrollBarEventProc);
            }
         }
         return this.var_435;
      }
