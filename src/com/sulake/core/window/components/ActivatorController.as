package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_334)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1193)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_870;
         if(this.var_870 != param1)
         {
            if(this.var_870 != null)
            {
               if(!this.var_870.disposed)
               {
                  this.var_870.deactivate();
               }
            }
            this.var_870 = param1;
