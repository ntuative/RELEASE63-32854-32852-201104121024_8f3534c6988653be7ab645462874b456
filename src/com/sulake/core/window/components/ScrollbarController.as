package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1405:String = "increment";
      
      private static const const_1406:String = "decrement";
      
      private static const const_1008:String = "slider_track";
      
      private static const const_639:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_699:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_173 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_545;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_17.removeEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_17.removeEventListener(WindowEvent.const_593,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_593,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1014 != null)
         {
            _loc2_ = this.var_1014;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1014 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1008) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_639) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_639:
               if(param2.type == WindowEvent.const_209)
               {
                  if(!this.var_1235)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_882)
         {
            if(this.var_17 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_333)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_699;
                  }
                  else
                  {
                     this.scrollV -= this.var_699;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_869)
         {
            ...
            else if(param2.name == const_1406)
            {
               if(this.var_17)
               {
                  this.var_1235 = true;
            ...
            else if(param2.name == const_1008)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_639).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_333)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1014) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1014) as IScrollableWindow;
               if(_loc1_)
               {
