package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_407);
         if(_loc1_)
         {
      ...
      {
         if(this.var_407 != param1.name)
         {
            this.var_407 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2492 = _loc2_.textWidth;
         this.var_2491 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_361 != _loc2_.color : this.var_361 != null && this.var_361 != PropertyDefaults.const_796) ? new PropertyStruct(PropertyDefaults.const_415,this.var_361,PropertyStruct.const_139,true) : PropertyDefaults.const_1192);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_855)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,this.var_42.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_544);
            }
            if(this.var_42.top != PropertyDefaults.const_666)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,this.var_42.top,PropertyStruct.const_42,true));
            }
            else
            {
            ...
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,this.var_42.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_547);
            }
            if(this.var_42.bottom != PropertyDefaults.const_797)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_276,this.var_42.bottom,PropertyStruct.const_42,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_379:
                  ...
                  break;
               case PropertyDefaults.const_415:
