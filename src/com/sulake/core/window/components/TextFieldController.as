package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_706:Boolean = false;
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_706 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_171,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_394,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_380,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_100,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_900,false,PropertyStruct.const_41,true) : PropertyDefaults.const_1507);
         _loc1_.push(this.var_1323 != PropertyDefaults.const_1071 ? new PropertyStruct(PropertyDefaults.const_877,this.var_1323,PropertyStruct.const_41,true) : PropertyDefaults.const_1575);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1226 ? new PropertyStruct(PropertyDefaults.const_851,_field.selectable,PropertyStruct.const_41,true) : PropertyDefaults.const_1495);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1041 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_41,true) : PropertyDefaults.const_1501);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_877:
                  this.var_1323 = _loc2_.value as Boolean;
                  if(this.var_1323)
                  {
               ...
               case PropertyDefaults.const_900:
                  ...
                  break;
               case PropertyDefaults.const_1153:
