package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1261:Dictionary = createPropertySetterTable();
      ...
      protected var var_124:Boolean = false;
      
      protected var var_1061:Boolean = false;
      
      private var var_407:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_407,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_407 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_407,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_183);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_739 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_407);
      }
      ...
      {
         this.var_861 = param1;
         this._field.scrollH = this.var_861 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_861 * this.maxScrollH,this.var_564 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_407);
         _loc1_.push(new PropertyStruct("always_show_selection",this._field.alwaysShowSelection,PropertyStruct.const_41,this._field.alwaysShowSelection != false));
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1228) ? new PropertyStruct(PropertyDefaults.const_754,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1126) : PropertyDefaults.const_1530);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1213 ? new PropertyStruct(PropertyDefaults.const_715,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1244) : PropertyDefaults.const_1494);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_41,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_139,this._field.borderColor != 0));
         _loc1_.push(new PropertyStruct("condense_white",this._field.condenseWhite,PropertyStruct.const_41,this._field.condenseWhite != false));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_277,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1074 ? new PropertyStruct(PropertyDefaults.const_1118,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1060) : PropertyDefaults.const_1632);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_796) ? new PropertyStruct(PropertyDefaults.const_415,this._field.textColor,PropertyStruct.const_139,true) : PropertyDefaults.const_1192);
         _loc1_.push(this.var_407 != TextStyleManager.const_183 ? new PropertyStruct(PropertyDefaults.const_379,this.var_407,PropertyStruct.const_53,true,PropertyDefaults.const_744) : PropertyDefaults.const_1137);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_855 ? new PropertyStruct(PropertyDefaults.const_242,this.var_42.left,PropertyStruct.const_42,true) : PropertyDefaults.const_544);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_666 ? new PropertyStruct(PropertyDefaults.const_232,this.var_42.top,PropertyStruct.const_42,true) : PropertyDefaults.const_549);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_920 ? new PropertyStruct(PropertyDefaults.const_243,this.var_42.right,PropertyStruct.const_42,true) : PropertyDefaults.const_547);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_797 ? new PropertyStruct(PropertyDefaults.const_276,this.var_42.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_465);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1042 ? new PropertyStruct(PropertyDefaults.const_822,this._field.mouseWheelEnabled,PropertyStruct.const_41,true) : PropertyDefaults.const_1515);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_42,this._field.maxChars != 0));
         _loc1_.push(new PropertyStruct("multiline",this._field.multiline,PropertyStruct.const_41,this._field.multiline != false));
         _loc1_.push(new PropertyStruct("restrict",this._field.restrict,PropertyStruct.const_53,this._field.restrict != null));
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_115,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_115,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_41,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("bold",this._field.defaultTextFormat.bold != false,PropertyStruct.const_41,this._field.defaultTextFormat.bold != false && _loc2_.fontWeight != FontStyle.BOLD));
         _loc1_.push(new PropertyStruct("italic",this._field.defaultTextFormat.italic != false,PropertyStruct.const_41,this._field.defaultTextFormat.italic != false && _loc2_.fontStyle != FontStyle.ITALIC));
         _loc1_.push(new PropertyStruct("underline",this._field.defaultTextFormat.underline != false,PropertyStruct.const_41,this._field.defaultTextFormat.underline != false && _loc2_.textDecoration != "underline"));
         _loc1_.push(new PropertyStruct("kerning",this._field.defaultTextFormat.kerning != false,PropertyStruct.const_41,this._field.defaultTextFormat.kerning != false && !_loc2_.kerning));
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_115,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
