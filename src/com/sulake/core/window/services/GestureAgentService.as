package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1354:uint = 0;
      
      protected var var_289:Function;
      
      protected var var_1309:int;
      
      protected var var_1310:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         {
            this._window = param1;
            this._window.addEventListener(WindowEvent.const_335,this.clientWindowDestroyed);
            this.var_289 = param2;
            this._working = true;
            this.var_1309 = param4;
            this.var_1310 = param5;
            this.var_213 = new Timer(40,0);
            this.var_213.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_213.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1309 *= 0.75;
         this.var_1310 *= 0.75;
         if(Math.abs(this.var_1309) <= 1 && Math.abs(this.var_1310) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_289 != null)
         {
            this.var_289(this.var_1309,this.var_1310);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_213.stop();
            this.var_213.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_213 = null;
         }
         if(this._working)
         {
            if(this._window == param1)
            {
               ...
               {
                  this._window.removeEventListener(WindowEvent.const_335,this.clientWindowDestroyed);
               }
               this._window = null;
               this._working = false;
            }
