package com.sulake.core.window.events
{
   ...
   public class WindowTouchEvent extends WindowEvent
   {
      ...
      public static const const_825:String = "WTE_BEGIN";
      
      public static const const_1064:String = "WTE_END";
      
      public static const const_1936:String = "WTE_MOVE";
      
      public static const const_1990:String = "WTE_OUT";
      
      public static const const_2015:String = "WTE_OVER";
      
      public static const const_1855:String = "WTE_ROLL_OUT";
      
      public static const const_1877:String = "WTE_ROLL_OVER";
      
      public static const const_869:String = "WTE_TAP";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Boolean, param12:Boolean, param13:Boolean) : WindowTouchEvent
      {
         ...
         _loc14_.var_694 = param3;
         _loc14_.var_570 = false;
         _loc14_.var_693 = POOL;
      ...
      {
         return allocate(_type,window,related,this.localX,this.localY,this.sizeX,this.sizeY,this.stageX,this.stageY,this.var_2870,this.altKey,this.ctrlKey,this.shiftKey);
      }
