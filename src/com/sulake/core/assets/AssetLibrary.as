package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1047:String = "AssetLibraryReady";
      
      public static const const_688:String = "AssetLibraryLoaded";
      
      public static const const_1663:String = "AssetLibraryUnloaded";
      
      public static const const_1660:String = "AssetLibraryLoadError";
      
      private static const const_434:String = "name";
      
      private static const const_982:String = "asset";
      
      private static const const_984:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_983:String = "library";
      
      private static var var_310:Dictionary;
      
      private static var var_1817:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_519:uint = 0;
      
      private static var var_965:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_519;
         this.var_433 = new Dictionary(false);
         this.var_518 = new Dictionary(false);
         this.var_963 = new Dictionary(false);
         this.var_163 = new Dictionary(false);
         var_965.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_629 + " doesn\'t contain valid resource class!");
         }
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_434);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_984);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_629 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_965.splice(var_965.indexOf(this),1);
            --var_519;
            this.var_518 = null;
            this.var_963 = null;
            this.var_163 = null;
      ...
      {
         if(this.var_629 == param1.url && this.var_966)
         {
            ...
            this.var_964 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1047));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_966 = false;
         this.var_629 = null;
         dispatchEvent(new Event(AssetLibrary.const_1663));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_963[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_518[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1092,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1063,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1145,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1155,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_518[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_518[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_163[struct.assetName] == null)
                  {
                     ++this.var_432;
                     this.var_431.push(struct.assetName);
                  }
                  this.var_163[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_518[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_163[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_431.length ? this.getAssetByName(this.var_431[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_163)
         {
            if(this.var_163[_loc2_] == param1)
            {
               return this.var_431.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_163[param1] != null || (this.var_628 != null ? this.var_628[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_163[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1817.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_163)
            {
               if(this.var_163[_loc2_] == param1)
               {
                  this.var_431.splice(this.var_431.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_310.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_310[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_433.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_433[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_310[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_433[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_310)
            {
               _loc3_ = AssetTypeDeclaration(var_310[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_433)
         {
            _loc3_ = AssetTypeDeclaration(this.var_433[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_310)
            {
               _loc4_ = AssetTypeDeclaration(var_310[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_433)
         {
            _loc4_ = AssetTypeDeclaration(this.var_433[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_629 = _loc2_.url;
         if(this.var_964)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_628);
         }
         this.var_966 = true;
         dispatchEvent(new Event(AssetLibrary.const_688));
         dispatchEvent(new Event(AssetLibrary.const_1047));
         if(this.var_964)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1660));
         this.var_43 = null;
      }
