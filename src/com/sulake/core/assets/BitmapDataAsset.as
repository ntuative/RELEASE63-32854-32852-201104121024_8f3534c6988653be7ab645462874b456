   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_103 is BitmapDataAsset)
         {
            ...
            this.var_1348 = BitmapDataAsset(this.var_103).var_1348;
            this.var_1349 = BitmapDataAsset(this.var_103).var_1349;
            if(this._bitmap != null)
            {
               this.var_103 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1348 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1349 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
