package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1757:uint = 1;
      
      protected static const const_1756:uint = 2;
      
      protected static const const_1755:uint = 4;
      
      protected static const const_1754:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1548:int = 5;
      ...
      private static var var_979:Array = new Array();
      
      private static var var_785:Array = new Array();
      ...
      protected var var_1067:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1068:Boolean = false;
      
      protected var var_2884:String = "";
      
      protected var var_2883:String = "";
      
      protected var var_2098:int;
      
      protected var var_1311:int;
      
      protected var var_1312:int;
      
      protected var var_2961:uint = 0;
      
      protected var var_2882:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_43.load(param1.var_242,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1052)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_785[_loc2_] as LibraryLoader;
            ...
            while(var_785.length < const_1561 && false)
            {
               _loc1_ = var_979.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_785.push(_loc1_);
                  _loc1_.var_43.load(_loc1_.var_242,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1067 ? uint(this.var_1311 - this.var_2098) : uint(getTimer() - this.var_2098);
      }
      ...
      {
         if(this.var_1068 && !_disposed)
         {
            this.var_1068 = false;
            if(!this.var_1067 && this.var_242)
            {
               this.var_1311 = -1;
      ...
      {
         if(!this.var_1067 && !_disposed && this.var_1312 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_242,const_1548 - this.var_1312);
            if(this.var_2882)
            {
            ...
            --this.var_1312;
            this.var_474 = 0;
            this.var_43.load(this.var_242,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_474 = LibraryLoader.name_4;
         ...
         if(this.var_474 == LibraryLoader.const_1754)
         {
         ...
         if(this.var_474 == LibraryLoader.name_4)
         {
