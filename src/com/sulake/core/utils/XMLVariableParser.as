package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1680:String = "float";
      
      public static const const_41:String = "Boolean";
      
      public static const const_1583:String = "bool";
      ...
      private static const const_619:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_620:String = "value";
      
      private static const const_646:String = "true";
      
      private static const const_1762:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_619);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_619));
         }
         else
         {
            _loc4_ = param1.child(const_619)[0];
         }
         ...
         _loc7_ = param1.attribute(const_620);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_620));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_620)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_237 || _loc5_ == const_152)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1680:
               return Number(param1);
            case const_41:
               return param1 == const_646 || int(param1) > 0;
            case const_1583:
               return param1 == const_646 || int(param1) > 0;
            case const_139:
               return uint(param1);
            case const_152:
               return param1.split(const_1304);
            default:
