package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_383:IRoomObject;
      
      private var var_758:IGraphicAssetCollection;
      
      protected var var_472:int = -1;
      
      protected var var_172:int = -1;
      
      protected var var_90:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_201 != null)
         {
            ...
            {
               _loc1_ = this.var_201[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_758.removeReference();
         }
         this.var_758 = param1;
         if(this.var_758 != null)
         {
            this.var_758.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_201.length > param1)
         {
            _loc2_ = this.var_201[this.var_201.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_201.length;
      }
      
      public function getSprite(param1:int) : IRoomObjectSprite
      {
         if(param1 >= 0 && param1 < this.var_201.length)
         {
            return this.var_201[param1];
         }
         return null;
      }
