package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_249)
            {
               _loc3_ = this.var_249[_loc1_];
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean, param4:int = 0, param5:int = 0) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            _loc6_ = new BitmapDataAsset(this.var_368.getAssetTypeDeclarationByClass(BitmapDataAsset));
            this.var_368.setAsset(param1,_loc6_);
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_631 != null)
         {
            if(param1 || this.var_631.length > const_1367)
            {
