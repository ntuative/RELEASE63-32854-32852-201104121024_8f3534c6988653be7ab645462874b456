package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1050:int = 2;
      
      public static const const_928:int = 3;
      ...
      private var var_166:IRoomManagerListener;
      
      private var var_2957:IRoomContentLoader;
      
      private var var_671:IRoomObjectFactory = null;
      
      private var var_555:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1263:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_672 = [];
         this.var_619 = [];
         events.addEventListener(RoomContentLoadedEvent.const_364,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_612,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_730,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_123.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_123.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_671 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_671 == null || this.var_555 == null)
         {
            return;
         }
         this._state = const_1503;
         if(this.var_1263 != null)
         {
            _loc1_ = this.var_1263;
            this.var_1263 = null;
            this.initialize(_loc1_,this.var_166);
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_619.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_619.push(param1);
         var _loc3_:int = this.var_123.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_123.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      {
         var _loc5_:int = 0;
         if(this._state < const_928)
         {
            throw new RoomManagerException();
         }
         if(this.var_123.getValue(param1) != null)
         {
            return null;
         }
         var _loc3_:RoomInstance = new RoomInstance(param1,this);
         this.var_123.add(String(param1),_loc3_);
         var _loc4_:int = this.var_619.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_619[_loc4_];
      ...
      {
         return this.var_123.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_123.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_555.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_555.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_671.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_671 != null)
         {
            return this.var_671.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
            ...
            if(this.var_672.length == 0)
            {
               ...
               {
                  this.var_166.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_940;
            this.var_166.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_166 != null)
            {
               this.var_166.contentLoaded(null,false);
            }
            return;
         }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1033.length > 0)
         {
            ...
            if(_loc3_ == null)
            {
               if(this.var_166 != null)
               {
                  this.var_166.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_166 != null)
            {
               this.var_166.contentLoaded(_loc2_,true);
            }
            if(this.var_672.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_555 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_555.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_123.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_123.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_123.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_555.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_671.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_166 != null)
                              {
                                 this.var_166.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_123.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_123.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
