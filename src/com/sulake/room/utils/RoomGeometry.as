package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_683:Number = 64;
      
      public static const const_1160:Number = 32;
      ...
      private var var_148:Vector3d;
      
      private var var_2033:Vector3d;
      
      private var var_561:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1295:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_465:Number = 1.0;
      
      private var var_463:Number = 1.0;
      
      private var var_464:Number = 1.0;
      
      private var var_2031:Number = 1.0;
      
      private var var_2034:Number = 1.0;
      
      private var var_2032:Number = 1.0;
      ...
      private var var_2929:Number = 500.0;
      
      private var var_253:Number;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_2033 = new Vector3d();
         this.var_561 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1295 = new Vector3d();
         this.var_2031 = 1;
         this.var_2034 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2032 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_2033.assign(this.var_148);
         return this.var_2033;
      }
      
      public function get location() : IVector3d
      {
         this.var_561.assign(this.var_94);
         this.var_561.x *= this.var_465;
         this.var_561.y *= this.var_463;
         this.var_561.z *= this.var_464;
         return this.var_561;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_393);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_465 != param1 * this.var_2031)
         {
            this.var_465 = param1 * this.var_2031;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_463 != param1 * this.var_2034)
         {
            this.var_463 = param1 * this.var_2034;
            ++this.var_169;
         }
      }
      ...
      {
         if(this.var_464 != param1 * this.var_2032)
         {
            this.var_464 = param1 * this.var_2032;
            ++this.var_169;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_94.x /= this.var_465;
         this.var_94.y /= this.var_463;
         this.var_94.z /= this.var_464;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_393.x;
         var _loc3_:Number = this.var_393.y;
         var _loc4_:Number = this.var_393.z;
         this.var_393.assign(param1);
         if(this.var_393.x != _loc2_ || this.var_393.y != _loc3_ || this.var_393.z != _loc4_)
         {
            ++this.var_169;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_147.assign(_loc24_);
            this.var_148.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_147.assign(_loc19_);
            this.var_148.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_560 != null)
         {
            ...
            this.var_560.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_560.add(_loc3_,_loc4_);
            ++this.var_169;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_560 != null)
         {
            ...
            return this.var_560.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1295.assign(_loc22_);
         }
         else
         {
            this.var_1295.assign(_loc17_);
         }
         ++this.var_169;
      }
      ...
      {
         if(param1 == null || this.var_148 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_148,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_147);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_148);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_465;
         _loc2_.y *= this.var_463;
         _loc2_.z *= this.var_464;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1295);
         if(_loc3_ < this.var_2930 || _loc3_ > this.var_2929)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_147);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_463;
            _loc2_.z *= this.var_464;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1295);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_147,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_94.x * this.var_465,this.var_94.y * this.var_463,this.var_94.z * this.var_464);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_148;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_465,param2.y * this.var_463,param2.z * this.var_464);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_465,param3.y * this.var_463,param3.z * this.var_464);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_465,param4.y * this.var_463,param4.z * this.var_464);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1160;
         }
         else
         {
            this.scale = const_683;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_683;
      }
