package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1536:int = 128;
      
      private var var_1537:Boolean = false;
      
      private var var_2925:Point;
      ...
      {
         if(param1 != this.var_1977 || param2 != this.var_1978)
         {
      ...
      {
         if(this.var_1536 > 255 || bitmapData == null)
         {
            return false;
         }
