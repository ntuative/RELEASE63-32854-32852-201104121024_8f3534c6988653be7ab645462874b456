package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_1338:uint = 88000;
      
      private static const const_1337:uint = 88000;
      ...
      private var var_1419:Sound;
      
      private var var_422:SoundChannel;
      
      private var var_1421:TraxData;
      ...
      {
         this.var_1418 = uint(30);
         super();
         this._events = param4;
         this.var_1837 = param1;
         this.var_501 = 1;
         this.var_1419 = new Sound();
         this.var_422 = null;
      ...
      {
         this.var_200 = uint(param1 * const_113);
      }
      ...
      {
         return this.var_421 / const_113;
      }
      
      public function set fadeOutSeconds(param1:Number) : void
      {
         this.var_421 = int(param1 * const_113);
      }
      
      public function get fadeInSeconds() : Number
      {
         return this.var_755 / const_113;
      }
      
      public function set fadeInSeconds(param1:Number) : void
      {
         this.var_755 = int(param1 * const_113);
      }
      ...
      public function set volume(param1:Number) : void
      {
         ...
         {
            this.var_422.soundTransform = new SoundTransform(this.var_501);
         }
      }
      
      public function get length() : Number
      {
         return this.var_352 / const_113;
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1421.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1421.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1752.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
               ...
               while(_loc11_ < _loc10_)
               {
                  ...
                  _loc5_ += _loc9_;
                  _loc4_ = uint(_loc5_ * const_1337);
                  _loc11_++;
               }
               if(this.var_352 < _loc4_)
               {
                  this.var_352 = _loc4_;
               }
               _loc6_++;
      ...
      public function play(param1:Number = 0.0) : Boolean
      {
         ...
         this.var_507 = 0;
         this.var_610 = false;
         this.var_1419.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this.var_1420 = param1 * const_113;
         this.var_1152 = 0;
         this.var_1753 = 0;
         this.var_422 = this.var_1419.play();
         return true;
      }
      ...
      {
         if(this.var_421 > 0 && !this.var_610)
         {
      ...
      private function stopImmediately() : void
      {
         ...
         this.var_1419.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
      }
      ...
      private function stopWithFadeout() : void
      {
         if(this.var_611 == null)
         {
            this.var_756 = true;
            this.var_507 = 0;
            this.var_611 = new Timer(this.var_1418 + this.var_421 / (const_113 / 1000),1);
            this.var_611.start();
      ...
      {
         return Math.ceil(param1 / const_1338);
      }
      ...
      private function getChannelSequenceOffsets() : Array
      {
         ...
         var _loc5_:int = 0;
         var _loc1_:* = [];
         var _loc2_:int = this.var_936.length;
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = this.var_936[_loc3_];
            _loc5_ = 0;
      ...
      private function mixChannelsIntoBuffer() : void
      {
         ...
         while(_loc4_ >= 0)
         {
            ...
            _loc8_ = const_181;
            if(this.var_352 - this.var_200 < _loc8_)
            {
               _loc8_ = this.var_352 - this.var_200;
            }
            _loc9_ = 0;
            while(_loc9_ < _loc8_)
            {
      ...
      {
         var _loc1_:int = this.var_352 < this.var_1420 ? int(this.var_352) : (this.var_1420 > 0 ? int(this.var_1420) : int(this.var_352));
         if(this.var_200 > _loc1_ + this.var_1418 * (const_113 / 1000) && !this.var_610)
         {
            this.var_610 = true;
            if(this.var_420 != null)
            {
               this.var_420.reset();
               this.var_420.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onPlayingComplete);
            }
            this.var_420 = new Timer(2,1);
            this.var_420.start();
            this.var_420.addEventListener(TimerEvent.TIMER_COMPLETE,this.onPlayingComplete);
         }
         else if(this.var_200 > _loc1_ - this.var_421 && !this.var_756)
         {
            this.var_935 = false;
            this.var_756 = true;
            this.var_507 = 0;
      ...
      {
         if(param1.position > this.var_1152)
         {
            ++this.var_1753;
            Logger.log("Audio buffer under run...");
            this.var_1152 = param1.position;
         }
         if(this.volume > 0)
         {
         ...
         if(this.var_352 - this.var_200 < _loc2_)
         {
            _loc2_ = this.var_352 - this.var_200;
            if(_loc2_ < 0)
            {
               _loc2_ = 0;
            }
         ...
         this.var_200 += const_181;
         this.var_1152 += const_181;
         if(this.var_422 != null)
         {
            this.var_1418 = param1.position / const_113 * 1000 - this.var_422.position;
         }
      ...
      private function writeAudioToOutputStream(param1:ByteArray, param2:int) : void
      {
         ...
         if(param2 > 0)
         {
            ...
            else
            {
               if(this.var_935)
               {
                  _loc5_ = 1 / this.var_755;
                  _loc6_ = this.var_937 / Number(this.var_755);
                  this.var_937 += const_181;
                  if(this.var_937 > this.var_755)
                  {
                     this.var_935 = false;
                  }
               }
               else if(this.var_756)
               {
                  _loc5_ = -1 / this.var_421;
                  _loc6_ = 1 - this.var_507 / Number(this.var_421);
                  this.var_507 += const_181;
                  if(this.var_507 > this.var_421)
                  {
                     this.var_507 = this.var_421;
                  }
               }
      ...
      {
         this.stopImmediately();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.var_1837));
      }
