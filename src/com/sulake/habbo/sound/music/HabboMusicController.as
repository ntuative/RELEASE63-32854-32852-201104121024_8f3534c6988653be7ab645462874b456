package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1366:int = HabboMusicPrioritiesEnum.const_117;
      ...
      private var var_515:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_814.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_814.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_814)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_905,this.onJukeboxInit);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_235,this.onJukeboxDispose);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_804,this.onSoundMachineInit);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_924,this.onSoundMachineDispose);
         this.var_1178 = new Timer(1000);
         this.var_1178.start();
         this.var_1178.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_239)
         {
            this.var_516[_loc6_] = null;
            this.var_778[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1815)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_381)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_498,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_814)
               {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_430.length)
               {
                  _loc3_ = this.var_430.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_82)
            {
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_905,this.onJukeboxInit);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_235,this.onJukeboxDispose);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_804,this.onSoundMachineInit);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_924,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_239)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_516[param1] = _loc7_;
         this.var_778[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_516[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_516[param1];
      ...
      {
         var _loc1_:int = this.var_516.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_516[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_430.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_239)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_626.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_364.length)
         {
            return this.var_364.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_364.length)
         {
            return this.var_364.getWithIndex(param1);
         }
         return -1;
      }
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_777));
         Logger.log("Requested song info\'s : " + this.var_777);
         this.var_777 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_430.add(_loc6_.id,_loc10_);
               ...
               while(this.var_776.indexOf(_loc6_.id) != -1)
               {
                  this.var_776.splice(this.var_776.indexOf(_loc6_.id),1);
                  if(this.var_776.length == 0)
                  {
                     this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_570));
                  }
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_239)
         {
            return false;
         }
         ...
         this.var_1815 = this.getSongRequestCountAtPriority(param1);
         this.var_1816 = param2;
         if(this._priorityPlaying <= const_1366)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_117)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_514,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2530 != param1.id || _loc3_ > this.var_2529 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2530 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_626.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_364.add(_loc5_,_loc6_);
            if(this.var_430.getValue(_loc6_) == null)
            {
               this.var_776.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_515 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_82,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_515 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
