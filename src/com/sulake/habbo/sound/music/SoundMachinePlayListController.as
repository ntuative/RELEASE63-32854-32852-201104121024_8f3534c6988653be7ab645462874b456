package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_71:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_71 = param2;
         this.var_814 = [];
         this.var_814.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_814.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_814)
         {
         ...
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_871,this.onSoundMachinePlayEvent);
         this.var_82.addEventListener(RoomEngineSoundMachineEvent.const_806,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_82)
            {
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_871,this.onSoundMachinePlayEvent);
               this.var_82.removeEventListener(RoomEngineSoundMachineEvent.const_806,this.onSoundMachineStopEvent);
               this.var_82 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_467 == param1)
         {
            this.playCurrentSongAndNotify(this.var_467);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_71.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_467 = -1;
         this.var_690 = false;
         this.var_71.stop(HabboMusicPrioritiesEnum.const_117);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_71.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_71.playSong(param1,HabboMusicPrioritiesEnum.const_117,_loc3_,0,0,0))
         {
