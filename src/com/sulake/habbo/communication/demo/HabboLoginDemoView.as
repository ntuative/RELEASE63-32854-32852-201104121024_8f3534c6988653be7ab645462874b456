package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_599:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_161.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_151,HabboWindowStyle.const_45,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1759,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_161.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1759,"/");
         ...
         {
            dispatchEvent(new Event(const_599));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_138.removeEventListener(SSOTicket.const_377,this.onParsedTicketSuccess);
            this.var_138.removeEventListener(SSOTicket.const_302,this.onParsedTicketFailure);
            this.var_138 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_138 = new SSOTicket(this.var_161.assets,_loc3_,_loc2_,param1);
         this.var_138.addEventListener(SSOTicket.const_377,this.onParsedTicketSuccess);
         this.var_138.addEventListener(SSOTicket.const_302,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_138.ticket);
         Logger.log("Has Facebook: " + this.var_138.isFacebookUser);
         if(this.var_138.isFacebookUser)
         {
            this.var_161.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_161.flashClientUrl = this.var_138.flashClientUrl;
         this.var_161.ssoTicket = this.var_138.ticket;
         this.var_138.removeEventListener(SSOTicket.const_377,this.onParsedTicketSuccess);
         this.var_138.removeEventListener(SSOTicket.const_302,this.onParsedTicketFailure);
         this.var_138 = null;
         dispatchEvent(new Event(const_599));
