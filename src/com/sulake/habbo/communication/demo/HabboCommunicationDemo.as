package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_478:IKeyExchange;
      
      private var var_879:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2129:PseudoRandom;
      ...
      private const const_1759:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_579 = param1;
            this.var_55.initConnection(HabboConnectionType.const_244);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_88,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_55 && this.var_149 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_149.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_149.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_218.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_149.getKey("use.sso.ticket") == "1";
         this.var_579 = this.var_149.getKey("sso.ticket",null);
         this.var_1609 = this.var_149.getKey("flash.client.url","");
         this.var_2131 = this.var_149.getKey("external.variables.txt","");
         if(this.var_218 == null)
         {
            this.var_218 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_55.mode = HabboConnectionType.const_89;
            if(this.var_579)
            {
               this.var_55.initConnection(HabboConnectionType.const_244);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_599,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1107;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_244);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_785);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2129 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_89:
               _loc6_ = "";
               ...
               this.var_218.loadBannerImage(_loc7_ + "?token=" + this.var_1337,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1107:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1544:
               this.var_879 = this.generateRandomHexString(30);
               this.var_478 = new DiffieHellman(new BigInteger(this.var_149.getKey("connection.development.prime"),16),new BigInteger(this.var_149.getKey("connection.development.generator"),16));
               this.var_478.init(this.var_879);
               _loc8_ = this.var_478.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_478.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_478.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2129);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1336 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_253);
         connection.send(new VersionCheckMessageComposer(401,this.var_1609,this.var_2131));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1759,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_579 != null)
         {
            ...
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_194);
         }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2130)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_478 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_478.init(_loc14_);
            _loc15_ = this.var_478.getPublicKey(10);
