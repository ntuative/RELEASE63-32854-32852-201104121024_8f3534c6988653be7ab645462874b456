package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private var var_553:QuestMessageData;
      
      private var var_1069:Boolean = false;
      
      private const const_1959:String = "achievement_bg_001";
      ...
      private function onClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_67.send(new OpenQuestTrackerMessageComposer());
            this.dispose();
         }
      }
      ...
      {
         this.var_189 = IFrameWindow(this.var_67.getXmlWindow("QuestCompletedDialog"));
         ...
         var _loc2_:String = "quest_" + this.var_553.campaignCode;
         var _loc3_:String = _loc2_ + "_" + this.var_553.localizationCode;
         var _loc4_:* = _loc3_ + ".completed.desc";
         this.var_67.localization.registerParameter(_loc4_,"amount",this.var_553.rewardCurrencyAmount.toString());
         this.var_189.findChildByName("description_txt").caption = this.var_67.localization.getKey(_loc4_);
         var _loc5_:* = _loc2_ + ".completed.currency";
         this.var_67.localization.registerParameter(_loc5_,"amount",this.var_553.rewardCurrencyAmount.toString());
         this.var_189.findChildByName("reward_txt").caption = this.var_67.localization.getKey(_loc5_);
         var _loc6_:IWindow = this.var_189.findChildByName("reward_info_txt");
         _loc6_.caption = this.var_67.localization.getKey(_loc2_ + ".completed.reward");
         ...
         var _loc8_:String = "icon_" + this.var_553.campaignCode + "_reward_" + this.var_553.rewardCurrencyAmount;
         this.var_67.setImageFromAsset(_loc7_,_loc8_,this.onRewardImageReady);
         var _loc9_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_189.findChildByName("background_image"));
         this.var_67.setImageFromAsset(_loc9_,"QuestCompletedBackground",this.onBackgroundImageReady);
         this.var_189.center();
      }
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(!this.var_1069 && this.var_189 && _loc2_)
         {
            _loc3_ = IBitmapWrapperWindow(this.var_189.findChildByName("quest.reward.icon"));
            this.var_67.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
      ...
      public function onRewardInfo(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         var _loc3_:String = "catalog.page.quest." + this.var_553.campaignCode;
         Logger.log("Questing->Open Catalog: " + _loc3_);
         this.var_67.openCatalog(_loc3_);
