package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_2017:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_67 = param1;
         this._communication = this.var_67.communication;
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         new QuestCompleted(this.var_67,_loc2_.questData);
      }
      ...
      private function onQuests(param1:IMessageEvent) : void
      {
         ...
         this.var_67.controller.onQuests(_loc2_.quests,_loc2_.openWindow);
      }
      ...
      private function onQuest(param1:IMessageEvent) : void
      {
         ...
         this.var_67.controller.onQuest(_loc2_.quest);
      }
      ...
      private function getCampaignCode() : String
      {
         ...
         var _loc2_:String = this.var_67.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_67.configuration.getKey("questing.excludedCampaignCode","");
      ...
      {
         this.var_67.controller.onRoomEnter();
         this.var_67.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.QUESTS));
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this.var_67.controller.onRoomExit();
         this.var_67.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.QUESTS));
      }
   }
}
