package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_873:String = "PLSV_ADD_SONGS";
      
      public static const const_1170:String = "PLSV_START_PLAYBACK";
      
      public static const const_538:String = "PLSV_NOW_PLAYING";
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_445[const_873];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_445.add(const_538,_loc1_);
