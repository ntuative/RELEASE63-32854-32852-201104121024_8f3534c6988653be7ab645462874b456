package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_849:String = "MISV_BUY_MORE";
      
      public static const const_665:String = "MISV_PREVIEW_PLAYING";
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1608.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_665,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_849,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_445.add(const_665,_loc1_);
            this.var_1607 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1608 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_520));
         }
         _loc2_ = this._widget.assets.getAssetByName("playlisteditor_inventory_subwindow_get_more_music") as XmlAsset;
         _loc1_ = this._widget.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_445.add(const_849,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_467));
         }
      }
