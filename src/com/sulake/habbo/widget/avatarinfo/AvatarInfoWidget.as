package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private var var_1167:Timer;
      
      private var var_2908:int = 3000;
      
      private var var_1429:Boolean;
      
      private var var_947:Boolean;
      
      private var var_847:Number;
      
      private var var_1428:int;
      
      private var var_2909:int = 500;
      
      private var var_355:AvatarInfoData;
      ...
      public function AvatarInfoWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboConfigurationManager, param4:IHabboLocalizationManager, param5:Component)
      {
         ...
         this.var_1429 = false;
         this.var_947 = false;
         this.var_1167 = new Timer(this.var_2908,1);
         this.var_1167.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
         this.var_355 = new AvatarInfoData();
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_840,0,0));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_106,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_393,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_106,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_393,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_110:
               ...
               this.var_355.amIAnyRoomController = _loc3_.amIAnyRoomController;
               this.var_355.amIController = _loc3_.amIController;
               this.var_355.amIOwner = _loc3_.amIOwner;
               this.var_355.canBeAskedAsFriend = _loc3_.canBeAskedAsFriend;
               this.var_355.canBeKicked = _loc3_.canBeKicked;
               this.var_355.canTrade = _loc3_.canTrade;
               this.var_355.canTradeReason = _loc3_.canTradeReason;
               this.var_355.hasFlatControl = _loc3_.hasFlatControl;
               this.var_355.isIgnored = _loc3_.isIgnored;
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_208,false,!!_loc3_.isSpectatorMode ? null : this.var_355);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_831,false,null);
               break;
            case RoomWidgetPetInfoUpdateEvent.PET_INFO:
               _loc5_ = param1 as RoomWidgetPetInfoUpdateEvent;
               this.updateView(_loc5_.id,_loc5_.name,_loc5_.roomIndex,RoomObjectTypeEnum.const_192,false,null);
               break;
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_89:
               this.var_1774 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_393:
               this.var_1774 = true;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_947)
         {
            ...
            this.var_847 = 1 - this.var_1428 / Number(this.var_2909);
         }
         else
         {
            this.var_847 = 1;
         ...
         this._view.update(_loc2_.rectangle,this.var_847);
      }
   }
}
