package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private var var_1094:int = -1;
      
      private var _window:IFrameWindow;
      
      private var _widget:PollWidget;
      
      private var var_409:IWindow;
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1094;
         if(this.var_1094 < this.var_891.length)
         {
            _loc1_ = this.var_891[this.var_1094] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function method_5() : Array
      {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_409)
         {
            ...
            this.var_409 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_409.center();
            this.var_409.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_891[this.var_1094] as Dictionary;
