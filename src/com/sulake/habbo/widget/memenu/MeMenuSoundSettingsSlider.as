package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1166:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1166.volume);
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1166.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_740 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_740.width,this.var_740.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_740,this.var_740.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_741 != null)
               {
                  ...
                  this.var_1682 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
