package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_157["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_157["dance_icon"] = ["dance_white","dance_color"];
         this.var_157["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_157["effects_icon"] = ["effects_white","effects_color"];
         this.var_157["badges_icon"] = ["badges_white","badges_color"];
         this.var_157["wave_icon"] = ["wave_white","wave_color"];
         this.var_157["hc_icon"] = ["_white","_color"];
         this.var_157["settings_icon"] = ["settings_white","settings_color"];
         this.var_157["credits_icon"] = ["credits_white","credits_color"];
         this.var_157["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            this.var_157[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_157[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_157)
         {
            _loc6_ = this.var_157[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_46)
                        {
         ...
         while(_loc5_ < this._window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_26,this.onMouseOverOrOut);
            _loc5_++;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1218);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1105));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_879);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1249));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_322);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1171));
               this._widget.hide();
               break;
            case "settings":
