package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2038:int = 1000;
      ...
      {
         super();
         this.var_213 = new Timer(this.const_2038);
         this.var_213.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_213.stop();
            this.var_213.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_213 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_177.isActive)
         {
            ...
            this.var_929.width = _loc2_ * this.var_293;
         }
         else
         {
            this.var_929.width = 0;
            this.var_213.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_752 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_752 == null)
            {
               return;
            }
         ...
         if(!this.var_177.isActive)
         {
            this.var_752.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_752.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_752.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            if(this.var_177.isActive)
            {
               ...
               this._window.addEventListener(WindowMouseEvent.const_26,this.onMouseEvent);
            }
            if(this.var_177.isInUse)
            {
         ...
         this.setTimeLeft();
         this.var_929 = this._window.findChildByName("loader_bar");
         if(this.var_929 != null)
         {
            this.var_293 = this.var_929.width;
            this.var_213.start();
            this.onUpdate();
         }
