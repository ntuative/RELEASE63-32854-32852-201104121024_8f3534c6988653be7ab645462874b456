package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_100:IWindowContainer;
      
      private var var_54:IBorderWindow;
      
      private var var_1157:TagListRenderer;
      
      private var var_135:IBorderWindow;
      
      private var var_2312:int;
      
      private const const_970:int = 5;
      
      private const const_1764:int = 7829367;
      
      private const const_1765:int = 16777215;
      
      private const const_2034:int = 2000;
      
      private const const_2035:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1157 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_53 == null || this.var_54 == null || this.var_100 == null)
         {
            return;
         }
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_54.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_54.width,this.var_100.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_54.width < this.var_100.width)
         {
         ...
         {
            this.var_100.x = this._window.width - this.var_100.width;
            this.var_54.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_100 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_100.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         var _loc5_:IBitmapWrapperWindow = this.var_54.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_54.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         while(_loc9_ < 5)
         {
            _loc8_ = this.var_54.findChildByName("badge_" + _loc9_);
            if(_loc8_ != null)
            {
               _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.showBadgeInfo);
               _loc8_.addEventListener(WindowMouseEvent.const_26,this.hideBadgeInfo);
            }
            _loc9_++;
         }
         _loc8_ = this.var_54.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_970;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1764;
            }
            else
            {
               _loc3_.textColor = this.const_1765;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_970,this.const_2035);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_380,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_380,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1157.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_100.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_100.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2312 > this.const_2034 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2312 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1764;
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_100.width = 250;
         var _loc2_:* = [];
         this.var_100.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
