package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_54:IBorderWindow;
      
      private var _buttons:IItemListWindow;
      
      private var var_53:IItemListWindow;
      
      private var var_202:PetCommandTool;
      
      private var _petData:Map;
      
      private var var_510:int;
      
      private const const_2050:int = 152;
      
      private const const_2042:int = 16;
      
      private const const_1347:int = 4;
      
      private const const_2041:uint = 14342874;
      
      private const const_2043:uint = 3815994;
      
      private const const_2051:uint = 2085362;
      
      private const const_2048:uint = 39616;
      
      private const const_2047:uint = 10513106;
      
      private const const_2053:uint = 8734654;
      
      private const const_2044:uint = 9094430;
      
      private const const_2049:uint = 6200576;
      
      private const const_2046:String = "happiness";
      
      private const const_2045:String = "experience";
      
      private const const_2052:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_54 == null || this._buttons == null)
         {
            return;
         }
         ...
         this.var_54.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_54.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_54.width < this._buttons.width)
         {
            this.var_54.x = this._window.width - this.var_54.width;
            this._buttons.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2046,param1.nutrition,param1.nutritionMax,this.const_2048,this.const_2051);
         this.updateStateElement(this.const_2045,param1.experience,param1.experienceMax,this.const_2053,this.const_2047);
         this.updateStateElement(this.const_2052,param1.energy,param1.energyMax,this.const_2049,this.const_2044);
         ...
         if(this.var_202 && this.var_202.isVisible() && param1.isOwnPet)
         {
            this.var_202.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_202.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2050,this.const_2042,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2041);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2043);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1347,_loc7_.width - 2,_loc7_.height - 2 - this.const_1347);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1347);
      ...
      private function openTrainView() : void
      {
         if(this.var_202 == null)
         {
            this.var_202 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_510) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_202.showWindow(true);
            this.var_202.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_54 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_54 != null)
         {
            this.var_53 = this.var_54.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_54.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_54.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_54.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_54.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_54.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_39,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_202 && this.var_202.getPetId() == this.var_510)
               {
                  this.var_202.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_609,this._widget.petData.ownerId);
