package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1768:String = "infostand_user_view";
      
      private const const_1772:String = "infostand_furni_view";
      
      private const const_1773:String = "infostand_pet_view";
      
      private const const_1771:String = "infostand_bot_view";
      
      private const const_1769:String = "infostand_jukebox_view";
      
      private const const_1770:String = "infostand_songdisk_view";
      
      private var var_1168:InfoStandFurniView;
      
      private var var_180:InfoStandUserView;
      
      private var var_356:InfoStandPetView;
      
      private var var_424:InfoStandBotView;
      
      private var var_948:InfoStandJukeboxView;
      
      private var var_949:InfoStandSongDiskView;
      
      private var var_2441:Array;
      
      private var var_1430:InfostandUserData;
      ...
      private const const_2040:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1168 = new InfoStandFurniView(this,this.const_1772,this._catalog);
         this.var_180 = new InfoStandUserView(this,this.const_1768);
         this.var_356 = new InfoStandPetView(this,this.const_1773,this._catalog);
         this.var_424 = new InfoStandBotView(this,this.const_1771);
         this.var_948 = new InfoStandJukeboxView(this,this.const_1769,this._catalog);
         this.var_949 = new InfoStandSongDiskView(this,this.const_1770,this._catalog);
         this.var_1430 = new InfostandUserData();
         this.var_667 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_160 = new Timer(this.const_2040);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_69,HabboWindowStyle.const_45,HabboWindowParam.const_45,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_106,this.onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_179,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_133,this.onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_750,this.onBadgeImage);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_426,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_106,this.onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_179,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_133,this.onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_750,this.onBadgeImage);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_426,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_369,this.var_356.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1768);
         if(this.var_160)
         {
            this.var_160.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_932)
         {
            this.var_948.update(param1);
            this.selectView(this.const_1769);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_366) != -1)
         {
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_356.update(this.petData);
      ...
      {
         this.var_356.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_180.setTags(param1.tags,this.var_2441);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_179:
               ...
               {
                  _loc2_ = param1.id == this.var_1430.userRoomId;
                  break;
               }
               if(this.var_356 != null && this.var_356.window != null && this.var_356.window.visible)
               {
      ...
      private function onSongUpdate(param1:RoomWidgetSongUpdateEvent) : void
      {
         ...
         this.var_949.updateSongInfo(param1);
      }
