package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_54 = _window.getListItemByName("info_border") as IBorderWindow;
         _buttons = _window.getListItemByName("button_list") as IItemListWindow;
         if(var_54 != null)
         {
            var_53 = var_54.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_54.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var_241 = var_54.findChildByTag("catalog");
         if(var_241 != null)
         {
            var_241.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
         var _loc7_:IBitmapWrapperWindow = var_54.findChildByName("icon_disc") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = var_54.findChildByName("icon_composer") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
      ...
      {
         var _loc2_:IWindowContainer = var_53.getListItemByName("trackname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_53.getListItemByName("creatorname_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_412)
         {
            this.var_1837 = param1.songId;
         }
         if(param1.songId == this.var_1837)
         {
            this._songName = param1.songName;
            this.var_2450 = param1.songAuthor;
            this.updateNowPlaying(this.var_1837 >= 0);
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:ITextWindow = var_53.getListItemByName("now_playing_text") as ITextWindow;
         if(_loc2_ != null)
         {
            if(param1)
            {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2450;
         }
         else
         {
