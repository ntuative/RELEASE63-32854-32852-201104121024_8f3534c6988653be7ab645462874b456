package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserNotificationEvent.const_564,this.method_4);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserNotificationEvent.const_564,this.method_4);
         super.unregisterUpdateEvents(param1);
      }
      
      protected function method_4(param1:RoomWidgetUserNotificationEvent) : void
      {
         var _loc2_:* = null;
         ...
         _loc2_ = var_59.getLocalization(param1.title);
         var _loc3_:String = !!_loc2_ ? _loc2_.raw : param1.title;
         _loc2_ = var_59.getLocalization(param1.message);
