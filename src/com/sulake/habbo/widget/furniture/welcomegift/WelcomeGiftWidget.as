package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_985:String = "welcome_gift_email_verified";
      
      private const const_1368:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1182)
         {
            this.setViewState(this.const_985);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_634:
               ...
               this._view.findChildByName("edit_text").visible = this.var_969;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_969);
               break;
            case this.const_985:
            ...
            case this.const_1368:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_969);
      ...
      {
         this.setViewState(this.const_1368);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_836,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1182 ? this.const_985 : this.const_634);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1453 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1453));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_581,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_677,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_581,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_677,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_581:
               this.var_1452 = param1.email;
               this.var_1182 = param1.isVerified;
               this.var_969 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1452 = this.var_1453;
            this.setViewState(this.const_634);
         }
         else
         {
            if(param1.result == this.const_2063)
            {
               this.var_969 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1453);
