package com.sulake.habbo.widget.furniture.trophy
{
   ...
   public class TrophyFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1415:Array = new Array(4293707079,4291411404,4290279476);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTrophyDataUpdateEvent.const_930,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTrophyDataUpdateEvent.const_930,this.onObjectUpdate);
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.color = const_1415[this._color];
         }
