package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1784:int = 0;
      
      private const const_1785:int = 1;
      
      private const const_1786:int = 2;
      
      private const const_1782:int = 3;
      
      private const const_1787:int = 4;
      
      private const const_2076:int = 0;
      
      private const const_2073:int = 1;
      ...
      private const const_2075:int = 5;
      
      private const const_1781:String = "deco_img";
      
      private const const_1783:String = "dialog_bg";
      
      private const const_2070:String = "%campaign%_dialog_bg.png";
      
      private const const_354:String = "%campaign%_gift_package.png";
      
      private const const_2077:String = "%campaign%_gift_content.png";
      
      private const const_2078:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1481 = this.var_149.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1481 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1479.length)
         {
            _loc2_ = this.var_1479.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_149 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_589,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_664,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_589,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_589:
               _loc2_ = this.const_1784;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_741:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_1782;
                     var_59.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
                     _loc2_ = this.const_1786;
                  }
               }
               else
               {
                  _loc2_ = this.const_1787;
               }
               this._shareId = null;
               this.var_1482 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_664:
               _loc2_ = this.const_1785;
               this.var_384 = param1.objectId;
               this._shareId = param1.data;
               this.var_401 = param1.status;
               this.var_1482 = param1.itemCategory;
               var_59.registerParameter("notifications.viral_furni.fb.title","realname",param1.ownRealName);
               var_59.registerParameter("notifications.viral_furni.fb.desc","realname",param1.ownRealName);
               var_59.registerParameter("widget.furni.teaser.gift.unlocked.desc","username",param1.firstClickUserName);
               break;
            default:
               Logger.log("Error, invalid viral widget update message: " + param1.type);
         }
         if(this._window && (this.var_1480 != _loc2_ || _loc3_ != this.var_184))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_184 = _loc3_;
         this.var_1480 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1480)
            {
               ...
               case this.const_1785:
                  ...
                  else if(this.var_401 == this.const_2073)
                  {
                  ...
                  else if(this.var_401 == this.const_2072)
                  {
                     ...
                     _loc3_ = var_59.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_59.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_354;
                  }
                  else if(this.var_401 == this.const_2074)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_184,"client.show.not_enough_fb_friends");
                     _loc3_ = var_59.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_59.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_354;
                  }
                  else if(this.var_401 == this.const_2071)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_184,"client.show.not_enough_fb_friends");
                     _loc3_ = var_59.getKey("widget.furni.teaser.gift.no_min_fb_friends.title");
                     _loc4_ = var_59.getKey("widget.furni.teaser.gift.no_min_fb_friends.desc");
                     _loc2_ = this.const_354;
                  }
                  else if(this.var_401 == this.const_2075)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_184,"client.show.campaign_closed");
                     _loc3_ = var_59.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                     _loc4_ = var_59.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
                     _loc2_ = this.const_354;
                  }
                  break;
               case this.const_1786:
                  _loc1_ = assets.getAssetByName("notification_gift_received") as XmlAsset;
                  _loc2_ = this.const_2078;
                  break;
               case this.const_1782:
                  _loc1_ = assets.getAssetByName("notification_gift_unlocked_notify") as XmlAsset;
                  _loc2_ = this.const_354;
                  break;
               case this.const_1787:
                  _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  _loc3_ = var_59.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                  _loc4_ = var_59.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
            }
            ...
            _loc5_ = this.const_2070.replace("%campaign%",this.var_184);
            this.setDecoImage(_loc5_,this.const_1783);
            _loc2_ = _loc2_.replace("%campaign%",this.var_184);
            this.setDecoImage(_loc2_,this.const_1781);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_838);
      ...
      {
         var _loc2_:String = var_59.getKey("notifications.viral_furni.fb.title");
         var _loc3_:String = var_59.getKey("notifications.viral_furni.fb.desc");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1482 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1482 == 1 ? "null" : InventoryCategory.const_145);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_933,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1479.push(new ImageDownloader(this,_assets,this.var_184,this.var_1481,param1,param2));
            return;
         }
