package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1155 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2417 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:int = this._widget.config.getKey("friendbar.enabled") == "true" ? 40 : 5;
         ...
         this.var_1795 = this._window.findChildByName("block_text");
         ...
         this.var_24.addEventListener(WindowKeyboardEvent.const_171,this.windowKeyEventProcessor);
         this.var_24.addEventListener(WindowEvent.const_100,this.onInputChanged);
      ...
      private function onSend(param1:WindowMouseEvent) : void
      {
         if(!this.var_1434)
         {
            this.sendChatFromInputField(this.var_2469);
         }
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc9_ = _loc8_.split(" ");
               if(_loc9_[0] == this.var_1155 && _loc9_.length == 3 && _loc9_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_508 = "";
               }
