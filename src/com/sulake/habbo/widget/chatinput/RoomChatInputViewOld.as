package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputViewOld
   {
      ...
      private static const const_1343:int = 11;
      
      private static const const_629:int = 18;
      
      private static const const_976:int = 16;
      
      private static const const_1344:int = 20;
      ...
      private var var_293:Number = 600;
      ...
      public function RoomChatInputViewOld(param1:RoomChatInputWidgetOld, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1155 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2417 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_171,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_100,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_226,this.onWindowMoved);
         this.var_1434 = true;
         this.var_508 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_629 + const_976;
         _loc1_.x = const_629;
         _loc1_.y = const_1343;
      }
      ...
      {
         this.var_293 = param1 - (const_629 + const_976);
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1155 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_508 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1344);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_508.length + 1)
            {
