package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1979:int = "F".charCodeAt(0);
      
      public static const const_1970:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_952 = param1.gender;
         this.var_843 = param1.online;
         this.var_1812 = param1.followingAllowed && param1.online;
         this.var_617 = param1.figure;
         this.var_1848 = param1.motto;
         this.var_1850 = param1.lastAccess;
         this.var_1375 = param1.categoryId;
         this.var_1847 = param1.realName;
