package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_175:String = "face";
      ...
      private var var_133:IHabboMessenger;
      ...
      private var var_2537:FriendListLookAndFeel;
      
      private var var_427:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1819:OpenedToWebPopup;
      ...
      private var var_1820:AvatarSearchResults;
      ...
      {
         this.var_2537 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1820 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_630.stop();
            this.var_630.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_630 = null;
         }
         ...
         if(this.var_133)
         {
            this.var_133.release(new IIDHabboMessenger());
            this.var_133 = null;
         }
         if(this.var_190)
         {
         ...
         if(this.var_779)
         {
            this.var_779.release(new IIDSessionDataManager());
            this.var_779 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1819 = new OpenedToWebPopup(this);
         }
         this.var_1819.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_367.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_315,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1181.createAvatarImage(param1,AvatarScaleType.const_87,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_190.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_190.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_133 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_367 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_101.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1199,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_408,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_101.addFriend(new Friend(_loc4_));
         }
         this.var_427 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_630)
         {
            this.var_630 = new Timer(120000);
            this.var_630.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_630.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_408);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_427.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_367.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_367.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_427.findTab(FriendListTab.const_96).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_367.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_427.findTab(FriendListTab.const_96);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1820.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_427.findTab(FriendListTab.const_96);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_779 || !this.var_367)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_779.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_367.vipLimit;
         }
         else if(this.var_779.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_367.clubLimit;
         }
         if(_loc2_ > this.var_367.limit)
         {
            this.var_367.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_175) as IBitmapWrapperWindow;
