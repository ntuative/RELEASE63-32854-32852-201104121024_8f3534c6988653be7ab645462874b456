package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_215:Boolean = true;
      
      private static const const_1288:Number = 25;
      
      private static const const_1340:Number = 90;
      
      private static const const_958:int = 50;
      
      private static const const_1289:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1352:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_588 = new Object();
         this.var_589 = new Array();
         this.var_587 = new Array();
         super();
         this._windowManager = param1;
         this.var_1352 = param2;
         this.var_710 = new Timer(const_1288);
         this.var_710.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < this.var_337.length)
         {
            this.repositionWindow(this.var_337[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_958 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_958 || param1.desktop.height - param1.y < const_1289;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1352.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_337.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1352.getIconLoc(param1.iconId);
      ...
      {
         return this.var_589[this.var_587.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_587[this.var_589.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            this.var_589.splice(_loc3_,1);
         }
         this.var_589.push(param1.name);
         this.var_587.push(param2);
         param1.addEventListener(WindowEvent.const_226,this.windowEventListener);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_588[_loc3_] == null)
            {
               this.var_588[_loc3_] = new Array();
            }
            if(this.var_588[_loc3_].indexOf(param1) < 0)
            {
               this.var_588[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_337.indexOf(param1) > -1)
         {
            if(const_215)
            {
            ...
            else
            {
               ...
               this.var_337.splice(this.var_337.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_589.length)
         {
            if(this.var_589[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_587[_loc2_];
               if(this.var_588[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_588[_loc3_].length)
                  {
                     this.repositionWindow(this.var_588[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         {
            _loc2_ = this._itemList[this.var_337[_loc7_]];
            if(_loc2_.active)
            {
