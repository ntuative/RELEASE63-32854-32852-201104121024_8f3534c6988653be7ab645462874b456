package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1520:LogoutController;
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_309.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1520 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_126,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1174,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_166,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1253,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1093,this.onHideWindowEvent);
         this._state = true;
