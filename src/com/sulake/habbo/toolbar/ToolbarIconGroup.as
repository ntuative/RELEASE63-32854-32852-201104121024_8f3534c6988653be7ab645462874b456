package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_2191:int = 5;
      
      private var var_2190:int;
      
      private var var_168:Number;
      
      private var var_2192:XML;
      ...
      {
         return this.var_1357.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2192.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_712.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1355.length)
         {
            _loc2_ = this.var_712.indexOf(this.var_1355[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_298[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1200 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_298[this.var_712.indexOf(param1)];
      }
