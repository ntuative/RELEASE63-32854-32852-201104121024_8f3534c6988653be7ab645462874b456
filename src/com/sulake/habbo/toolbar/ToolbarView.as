package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_558:String = "LEFT";
      
      private var var_168:Number = 50;
      
      private var var_1285:Boolean = true;
      
      private var var_1286:Number = 1;
      
      private var var_1559:Number = 0;
      
      private var var_2013:Number = 15;
      
      private var var_2014:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_168 = this._window.width;
         this.var_236 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_69,HabboWindowStyle.const_1196,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1285 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1285)
         {
         ...
         this.var_1286 = _loc8_.toolbar.@margin_top;
         this.var_1559 = _loc8_.toolbar.@margin_bottom;
         this.var_2013 = _loc8_.toolbar.@min_group_margin;
         this.var_2014 = _loc8_.toolbar.@margin_to_extrabar;
         this.var_305 = new ToolbarBarMenuAnimator(param1,this);
         var _loc9_:XMLList = XMLList(_loc8_.toolbar).children();
         var _loc10_:XMLList = XMLList(_loc8_.extras).children();
         this.createGroupsFromXmlList(_loc9_,this.var_281,param1,param2,param3,this._window,this.var_305);
         this.createGroupsFromXmlList(_loc10_,this.var_680,param1,param2,param3,this.var_236,this.var_305);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_168,this._config);
      ...
      public function dispose() : void
      {
         ...
         while(this.var_680.length > 0)
         {
            _loc1_ = this.var_680.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_168,this.var_558,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_558);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_168,this.var_558);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_168,this.var_558);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_908);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_680.length)
         {
            _loc2_ = this.var_680[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_236.x = this.var_168 + this.var_2014;
               this.var_236.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_168;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_168;
               this._window.y = 0;
               this.var_236.x = 0;
               this.var_236.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_168;
               this._window.x = 0;
               this._window.y = 0;
               this.var_236.x = 0;
               this.var_236.y = this.var_168 + this.var_2014;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_168;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_168;
               this.var_236.x = 0;
               this.var_236.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this.var_1559;
         _loc4_ -= this.var_1286;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1286;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_281.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_2013,(this._window.height - _loc5_ * _loc8_ - this.var_1286 - this.var_1559) / (this.var_281.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_2013,(this._window.width - _loc5_ * _loc8_ - this.var_1286 - this.var_1559) / (this.var_281.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_281.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_558;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_680.length)
         {
            _loc3_ = this.var_680[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1285 && this.var_1558)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_558)
            {
               this.var_558 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_600);
                  _loc3_.orientation = this.var_558;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_168)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_168)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_168)
         {
            return "BOTTOM";
         }
         return null;
