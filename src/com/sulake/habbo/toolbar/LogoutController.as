package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_549:int = 46;
      
      private const const_547:int = 3;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_547;
         _loc3_.y = this.const_549;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_681)
         {
            this.var_681 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
