package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_869:int = 0;
      
      protected var var_700:BitmapData;
      
      protected var var_2709:int;
      
      protected var var_1592:Boolean;
      
      protected var var_2111:Boolean;
      
      protected var var_2892:BitmapData;
      
      private const const_2029:int = 8947848;
      
      private const const_2028:int = 13421772;
      
      private const const_1798:Number = 1;
      
      private const const_1797:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2892 = param6;
         this.var_2111 = param7;
         this._items = new Map();
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2893 == FurniModel.const_47)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1449));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2097);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_866)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1797;
               _loc1_.blend = this.const_1797;
            }
            else
            {
               this._window.blend = this.const_1798;
               _loc1_.blend = this.const_1798;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2111 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2892;
               _loc5_.visible = true;
            }
            else
            {
