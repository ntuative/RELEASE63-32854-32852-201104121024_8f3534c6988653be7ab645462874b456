package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1399:IncomingMessages;
      ...
      private const const_2037:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_518,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_51.getValue(InventoryCategory.const_81));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_306));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_708));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_51.getValue(InventoryCategory.const_332));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_51.getValue(InventoryCategory.const_374));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_145));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_401) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1399 = new IncomingMessages(this);
      ...
      {
         this.var_405 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_88,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_518,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_88:
               this.var_1105 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_518:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_405 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_170 || !this._soundManager)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_170);
         this.var_51 = new Map();
         ...
         this.var_51.add(InventoryCategory.const_401,_loc1_);
         ...
         this.var_51.add(InventoryCategory.const_81,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_405);
         this.var_51.add(InventoryCategory.const_332,_loc3_);
         ...
         this.var_51.add(InventoryCategory.const_708,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_405);
         this.var_51.add(InventoryCategory.const_374,_loc5_);
         ...
         this.var_51.add(InventorySubCategory.const_306,_loc6_);
         ...
         this.var_51.add(InventoryCategory.const_145,_loc8_);
         this.var_193 = true;
         if(this.var_2323)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_306:
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2037);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_910));
      }
