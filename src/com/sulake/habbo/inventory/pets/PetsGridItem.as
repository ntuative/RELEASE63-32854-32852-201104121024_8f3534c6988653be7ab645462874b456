package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1330.setSelectedGridItem(this);
               this.var_1331 = true;
               break;
            ...
            case WindowMouseEvent.const_26:
               ...
               {
                  this.var_1331 = false;
                  this.var_1330.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1411.color = !!this._isSelected ? uint(this.const_2029) : uint(this.const_2028);
      }
