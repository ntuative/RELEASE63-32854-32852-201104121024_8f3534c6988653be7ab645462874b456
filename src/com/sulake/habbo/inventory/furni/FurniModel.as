package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_47:String = "S";
      
      public static const const_50:String = "I";
      
      public static const const_419:String = "pets";
      
      private static const const_1425:int = 100;
      ...
      private var var_1966:Vector.<Array>;
      
      private var var_1965:Vector.<Array>;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_165,this.onObjectPlaced);
               }
            ...
            {
               this.var_668.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_668.stop();
               this.var_668 = null;
            }
            if(this.var_210 != null)
            {
               this.var_210.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_210.stop();
               this.var_210 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_47)
            {
               ...
               {
                  this.var_1966 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1966;
            }
            else
            {
               if(this.var_1965 == null)
               {
                  this.var_1965 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1965;
            }
         ...
         if(this.getSelectedItemIndex(FurniModel.const_47) == -1)
         {
            this.toggleItemSelection(FurniModel.const_47,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_298)
         {
         ...
         else if(param3 == FurniCategory.const_342)
         {
         ...
         if(this.var_1029 == null)
         {
            this.var_1029 = this._windowManager.buildFromXML(this.var_2747) as IWindowContainer;
         }
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_47,const_50];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_210 = new Timer(param1,1);
            this.var_210.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_210.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_81 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_50:
                  ...
                  break;
               case const_419:
                  this._controller.toggleInventoryPage(InventoryCategory.const_145);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_401);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_47,const_50];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_47,const_50];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_667.add(const_47,new Array());
         this.var_667.add(const_50,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_193)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_306;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_330 || _loc3_.category == FurniCategory.const_298 || _loc3_.category == FurniCategory.const_342)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_866)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
