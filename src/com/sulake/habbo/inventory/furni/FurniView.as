package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2088:int = 0;
      
      private const const_1010:int = 1;
      
      private const const_1793:int = 2;
      
      private const const_1792:int = 3;
      
      private const const_1802:int = 42;
      
      private const const_1803:int = 120;
      ...
      private var var_833:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_453.add(FurniModel.const_47,new FurniGridView(this.var_68,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_453.add(FurniModel.const_50,new FurniGridView(this.var_68,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_453.getValue(this.var_452);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_68.getCategoryContent(this.var_452);
         if(!this.var_68.isListInited())
         {
            _loc2_ = this.const_1010;
         }
         ...
         if(this.var_2309 == _loc2_)
         {
            return;
         }
         this.var_2309 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_47,FurniModel.const_50];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_68.getGroupItemInIndex(_loc3_,this.var_452);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_289);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_300);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_317);
            ...
            if(_loc5_.category == FurniCategory.const_298)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_342)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_193)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_833 && this.var_833.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1112)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1803)
         {
            _loc3_ = this.const_1803;
         }
         else if(_loc3_ < this.const_1802)
         {
            _loc3_ = this.const_1802;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_419);
            }
         }
      }
