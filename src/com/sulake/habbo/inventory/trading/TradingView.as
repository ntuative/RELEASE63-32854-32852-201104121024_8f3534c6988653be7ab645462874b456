package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1021:uint = 4284532064;
      
      private static const const_1022:uint = 2577770;
      
      public static const const_1163:int = 0;
      ...
      private var var_682:ItemPopupCtrl;
      ...
      private var var_1045:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_682 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_213)
            {
               this.var_213.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_213.stop();
               this.var_213 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2021 = this.createMinimizedWindow();
         }
         if(!this.var_2837)
         {
            return this.var_72;
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_26,this.ownThumbEventProc);
            _loc6_++;
         }
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_26,this.othersThumbEventProc);
            _loc6_++;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_72)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1021) : uint(const_1022);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1021) : uint(const_1022);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_213 = new Timer(1000,3);
            this.var_213.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_213.reset();
         this.var_213.repeatCount = 3;
         this.var_213.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_213.currentCount));
         if(this.var_213.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1045)
         {
            this.var_1045.isSelected = false;
            this.var_1045 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1492)
            {
            ...
            this.var_682.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_607);
            this.var_682.show();
         }
         else if(param1.type == WindowMouseEvent.const_26)
         {
            this.var_682.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_192.push(param4);
            this.var_192.push(param1);
            this.var_192.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_192.length > 0)
         {
            _loc2_ = this.var_192.pop();
            _loc3_ = this.var_192.pop();
            _loc4_ = uint(this.var_192.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_682.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_607);
               }
            }
            else
            {
               this.var_192.push(_loc4_);
               this.var_192.push(_loc3_);
