package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1488:uint = 9;
      
      public static const const_189:uint = 0;
      
      public static const const_202:uint = 1;
      
      public static const const_399:uint = 2;
      
      public static const const_331:uint = 3;
      
      public static const const_613:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_738);
         this.var_56.updateItemList(this.var_1383);
      ...
      public function close() : void
      {
         if(this.var_770)
         {
            if(this._state != const_189 && this._state != const_238)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_737 + " OTHER: " + this.var_1124);
         ...
         {
            case const_189:
               if(param1 == const_202 || param1 == const_238)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_250 == null || this.var_250.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_250.length)
         {
            _loc2_ = this.var_250.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         if(this._state == const_399)
         {
            this.state = const_331;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1176);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_738)
            {
               this.var_737 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1124 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_738)
            {
               this.var_56.alertPopup(TradingView.const_1219);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_250.length < const_1488)
         {
         ...
         else
         {
            ...
            if(this.var_250.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
