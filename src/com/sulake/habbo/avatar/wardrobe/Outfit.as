package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit, IAvatarImageListener
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_87,this.var_952,this);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_37,int(FigureData.const_923));
