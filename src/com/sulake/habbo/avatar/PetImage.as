package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_272:AvatarImageCache;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1333);
            if(_loc3_ != null)
            {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_524 = this.var_524 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_378:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1565:
                  case AvatarAction.const_1711:
                  case AvatarAction.const_1598:
                  case AvatarAction.const_1067:
                  case AvatarAction.const_1173:
                  case AvatarAction.const_1714:
                  case AvatarAction.const_1538:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_332.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_872);
         this.getCache().resetBodyPartCache(this.var_872);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1332 = this._structure.sortActions(this.var_332);
         ...
         {
            this.var_809 = this._structure.getCanvasOffsets(this.var_1332,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1332)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_337)
               {
                  this.var_873 = true;
               }
            }
