package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1319:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1321:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_779:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1134:AvatarEditorHandler;
      ...
      private var var_920:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_101)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_193)
         {
            ...
            this.var_602["null"] = new FigureData(this);
            this.var_602["null"] = new FigureData(this);
            _loc2_ = this.var_602["null"];
            _loc3_ = this.var_602["null"];
            _loc2_.loadAvatarData(const_1319,FigureData.const_78);
            _loc3_.loadAvatarData(const_1321,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_500 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_898,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_255,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_886,new LegsModel(this));
            if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
            {
               this.var_101.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            }
            this.var_500.add(AvatarEditorSideCategory.const_108,new WardrobeModel(this));
            this.var_500.add(AvatarEditorSideCategory.const_463,new ClubPromoModel(this));
            this.var_193 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_602[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_101)
         {
            for each(_loc5_ in this.var_101)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_920.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_920.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_254 == null)
            {
               this.var_254 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_69,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_254.addChild(this._view.window);
               if(param5)
               {
                  this.var_254.center();
               }
            ...
            this.var_254.visible = !this.var_254.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_898);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_101.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_500.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_779 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_499 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_920 = this.var_499.getFigureData(AvatarType.const_123);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1134 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_602[this.var_952];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1393 != null)
         {
            ...
            this.var_1393.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1708;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1135 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1320)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1586.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_499.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_499.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1307.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1730)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1135 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1307.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function hasInvalidClubItems() : Boolean
      {
         ...
         for each(_loc2_ in this.var_101)
         {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1135 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_500.getValue(AvatarEditorSideCategory.const_108);
      }
