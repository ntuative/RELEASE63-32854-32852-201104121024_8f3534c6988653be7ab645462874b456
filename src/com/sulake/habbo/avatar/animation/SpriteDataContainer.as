package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2664:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1664 = parseInt(param2.@ink);
         this.var_2663 = String(param2.@member);
         this.var_2665 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1500 = [];
         this.var_1499 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1500[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1499[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1500.length)
         {
