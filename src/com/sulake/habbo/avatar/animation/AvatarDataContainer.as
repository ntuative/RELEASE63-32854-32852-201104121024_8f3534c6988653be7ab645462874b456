package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1664 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2240 = parseInt(_loc2_,16);
         this.var_2238 = parseInt(_loc3_,16);
         ...
         this.var_733 = new ColorTransform(this.var_1871,this.var_1870,this.var_1869,this._alphaMultiplier);
         this.var_1113 = this.generatePaletteMapForGrayscale(this.var_2238,this.var_2240);
      }
      ...
      {
         return this.var_1113.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1113.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1113.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1113.getValue("alphas") as Array;
      }
