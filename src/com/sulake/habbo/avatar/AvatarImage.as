package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1269:String = "Default";
      ...
      protected var var_1315:Boolean = false;
      ...
      private var var_2627:String = null;
      
      private var var_2628:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_617 = param3;
         this.var_272 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1270,const_1271);
         this.var_332 = new Array();
         this.var_872 = new ActiveActionData(AvatarAction.const_368);
         this.var_872.definition = this._structure.getActionDefinition(const_1269);
         this.resetActions();
      ...
      {
         param2 += this.var_1600;
         if(param2 < AvatarDirectionAngle.const_1162)
         {
            param2 = AvatarDirectionAngle.const_312 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_312)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_269.length == 1 && this.var_89 == this.var_1622)
         {
            return this.var_89 + this.var_524 + this.var_644 % 4;
         }
         if(this.var_269.length == 2)
         {
            for each(_loc1_ in this.var_269)
            {
               ...
               {
                  return this.var_89 + this.var_524 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_644 % 11;
                  return this.var_89 + "_" + this.var_1622 + this.var_524 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2629 || param2 != this.var_2627 || param1 != this.var_2628)
         {
            this.var_2629 = param3;
            this.var_2627 = param2;
            this.var_2628 = param1;
            this.var_1882 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1315 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1315)
            {
               this.var_47.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_287.definition.geometryType,this.var_89);
         this.var_47.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_644);
         ...
         if(this.var_571 != null)
         {
            if(this.var_571.paletteIsGrayscale)
            {
               ...
               this.var_47 = _loc13_;
               this.var_47.paletteMap(this.var_47,this.var_47.rect,new Point(0,0),this.var_571.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_644);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_332.push(new ActiveActionData(param1,param2,this.var_644));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_872;
         this.var_287.definition = this.var_872.definition;
         this.resetBodyPartCache(this.var_872);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_524 = "";
         this.var_269 = this._structure.sortActions(this.var_332);
         if(this.var_269 == null)
         {
            this.var_809 = new Array(0,0,0);
            if(this.var_1487 != "")
            {
               _loc1_ = true;
               this.var_1487 = "";
         ...
         {
            this.var_809 = this._structure.getCanvasOffsets(this.var_269,this._scale,this.var_89);
            for each(_loc4_ in this.var_269)
            {
               this.var_524 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_321)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1488 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1488 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1487 != this.var_524)
            {
               _loc1_ = true;
               this.var_1487 = this.var_524;
            }
         }
         this.var_1334 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_269)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_873 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1600 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_337 || _loc1_.actionType == AvatarAction.WAVE || _loc1_.actionType == AvatarAction.const_361)
               {
                  this.var_873 = true;
               }
            }
