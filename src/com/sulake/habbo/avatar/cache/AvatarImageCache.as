package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1791:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1476:IAvatarImage;
      ...
      private var var_122:AvatarImagePartContainer;
      ...
      private var var_1032:PaletteMap;
      
      private var var_1001:Array;
      
      private var var_1000:Point;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_272.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_272.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_272.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_272.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_272.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_272.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      {
         if(this.var_810 == param1)
         {
            return;
         }
         if(this.var_810 == GeometryType.const_1164 && param1 == GeometryType.const_1167 || this.var_810 == GeometryType.const_1167 && param1 == GeometryType.const_1164)
         {
            this.var_810 = param1;
            this.var_86 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_272.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_377.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_691)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1476.getFigure(),_loc5_,this.var_810,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_456 == null)
         {
            ...
            this.var_456 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_377);
            if(this.var_456 == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_272.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_272.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_86)
         {
            this.var_86 = this._structure.getCanvas(this._scale,this.var_810);
            if(!this.var_86)
            {
               return null;
            }
            this.var_2683 = new Point(0,this.var_86.height - int(this.var_86.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1532[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_876 || _loc10_ == AvatarAction.const_361;
         var _loc12_:int = param2.length - 1;
         _loc8_ = _loc12_;
         while(_loc8_ >= 0)
         {
            this.var_122 = param2[_loc8_] as AvatarImagePartContainer;
            if(!(param1 == 7 && (this.var_122.partType == "fc" || this.var_122.partType == "ey")))
            {
               this.var_1504 = this.var_122.bodyPartId;
               this.var_186 = this.var_122.partType;
               this.var_1910 = this.var_122.partId;
               this._frame = this.var_122.getFrameIndex(param3);
               _loc5_ = param1;
               _loc7_ = false;
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_122.flippedPartType != this.var_186)
                     {
                        this.var_186 = this.var_122.flippedPartType;
                     }
                  }
               }
               this.var_1503 = this._scale + "_" + this.var_122.action.assetPartDefinition + "_" + this.var_186 + "_" + this.var_1910 + "_" + _loc5_ + "_" + this._frame;
               this.var_438 = this._assets.getAssetByName(this.var_1503) as BitmapDataAsset;
               if(this.var_438 == null)
               {
                  this.var_1503 = this._scale + "_std_" + this.var_186 + "_" + this.var_1910 + "_" + _loc5_ + "_0";
                  this.var_438 = this._assets.getAssetByName(this.var_1503) as BitmapDataAsset;
               }
               if(!(!this.var_438 || !this.var_438.content))
               {
                  if(this.var_122.paletteMapId > -1)
                  {
                     this.var_1032 = this._structure.renderManager.paletteManager.getPalette(this.var_122.paletteMapId);
                     if(this.var_1032 != null)
                     {
                        this.var_1002 = this.var_438.content as BitmapData;
                        this.var_187 = new BitmapData(this.var_1002.width,this.var_1002.height);
                        this.var_2684 = this.var_1032.colorize(this.var_1002.getPixels(this.var_1002.rect));
                        this.var_187.setPixels(this.var_187.rect,this.var_2684);
                     }
                     else
                     {
                        this.var_187 = (this.var_438.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1504 == AvatarBodyPartType.const_255 || this.var_1504 == AvatarBodyPartType.const_1602 || this.var_1504 == AvatarBodyPartType.const_1466) && this.var_122.color != null)
                  {
                     _loc16_ = 0.7;
                     _loc17_ = this.var_122.color.colorTransform;
                  ...
                  else if(this.var_122.isColorable && this.var_122.color != null)
                  {
                     this.var_187.colorTransform(this.var_187.rect,this.var_122.color.colorTransform);
                  }
                  if(this.var_122.isBlendable)
                  {
                     this.var_187.colorTransform(this.var_187.rect,this.var_122.blendTransform);
                  }
                  this.var_1000 = this.var_438.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_54)
                     {
                  ...
                  this.var_2682 = new ImageData(this.var_187,this.var_1000,_loc7_);
                  this.var_1001.push(this.var_2682);
               }
            }
            _loc8_--;
         }
         if(this.var_1001.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1001,_loc6_);
         ...
         _loc8_ = this.var_1001.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1001.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
