package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1307:IWindowContainer;
      
      public static var var_1586:IWindowContainer;
      
      public static var var_2081:int = 6710886;
      ...
      private var var_349:ITabSelectorWindow;
      ...
      private var var_2308:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1133 = [];
         this.var_1392 = [AvatarEditorFigureCategory.const_898,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_255,AvatarEditorFigureCategory.const_886,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
         ...
         if(var_1307 == null)
         {
            ...
            var_1307 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1586 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1586 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_415 = new Timer(1000);
         this.var_415.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1392;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_415.stop();
            this.var_415.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_415 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1392);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2308 = this.canChangeOutfit();
            this.var_415.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_349 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_349.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_349.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1133.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_349.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_349.numSelectables)
               {
                  this.var_349.getSelectableAt(_loc6_).x = this.var_349.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_349.setSelected(this.var_349.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1392;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1705 == AvatarEditorSideCategory.const_108 || this.var_2306))
         {
         ...
         this.setViewToCategory(this.var_366);
      }
      ...
      {
         if(this.var_1705 == AvatarEditorSideCategory.const_108)
         {
            this.var_2306 = false;
            this.setSideContent(AvatarEditorSideCategory.const_773);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_773:
               break;
            case AvatarEditorSideCategory.const_463:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_463);
               break;
            case AvatarEditorSideCategory.const_108:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_108);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_366 = param1;
         this.var_349.setSelected(this.var_349.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2307 = new Date().valueOf();
                  this.var_2308 = false;
                  this.var_415.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2307 > 5000;
      }
   }
}
