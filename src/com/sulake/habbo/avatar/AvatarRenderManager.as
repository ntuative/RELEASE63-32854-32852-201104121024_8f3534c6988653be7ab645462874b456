package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2064:String = "hd-99999-99999";
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_687 = RenderMode.const_1600;
         ...
         this.var_106.add(AvatarType.const_123,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_311.init();
         this.var_781.init();
         _loc2_ = this.var_106.getValue(AvatarType.const_123) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_106.getValue(AvatarType.const_123) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_190.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_227 == null)
               {
                  ...
                  _loc6_ = this.var_190.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_190.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_966)
         {
            if(this.var_2546 && this.var_2544 && this.var_2545)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_106.getValue(AvatarType.const_123) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1826)
         {
            this.var_1826 = new AvatarFigureContainer(this.const_2064);
         }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_312 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_312.getKeys())
         {
            _loc4_ = this.var_312.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1688)
         {
         ...
         if(param5 != null)
         {
            ...
            this.var_312.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_312.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_312.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_106.getValue(AvatarType.const_123) as AvatarStructure;
