package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:CategoryData = this.var_101[param1];
         if(_loc2_ == null)
         {
            _loc3_ = this._controller.generateDataContent(this,param1);
            if(_loc3_)
            {
               this.var_101[param1] = _loc3_;
      ...
      {
         if(!this.var_101 || !this._controller || !this._controller.figureData)
         {
            return;
         }
         var _loc2_:CategoryData = this.var_101[param1];
      ...
      public function stripClubItemsOverLevel(param1:int) : Boolean
      {
         ...
         var _loc2_:Array = this.var_101.getKeys();
         var _loc3_:Boolean = false;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            _loc5_ = _loc2_[_loc4_];
            _loc6_ = this.var_101[_loc5_];
            _loc7_ = false;
      ...
      {
         var _loc3_:CategoryData = this.var_101[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc4_:CategoryData = this.var_101[param1];
         if(_loc4_ == null)
         {
            return;
         }
