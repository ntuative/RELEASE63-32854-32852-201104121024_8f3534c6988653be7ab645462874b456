   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_68,FigureData.const_264,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_shoes":
                  ...
                  break;
               case "tab_belts":
                  this.switchCategory(FigureData.const_264);
            }
         }
