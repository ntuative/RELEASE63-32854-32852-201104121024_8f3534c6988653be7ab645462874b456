package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_547 == null)
         {
            return;
         }
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_547.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_87)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1525.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_661.getValue(_loc6_) == null)
               {
                  ...
                  this.var_661.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_547.indexOf(param3) == -1)
                  {
                     this.var_547.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_661.getKeys())
         {
            _loc5_ = this.var_661.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_286.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
