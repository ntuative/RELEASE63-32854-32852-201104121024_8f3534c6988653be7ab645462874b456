package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2658 = parseInt(param1.@precedence);
         this.var_2660 = String(param1.@activepartset);
         this.var_2656 = String(param1.@assetpartdefinition);
         this.var_2659 = String(param1.@lay);
         this.var_810 = String(param1.@geometrytype);
         this.var_2452 = Boolean(parseInt(param1.@main));
         this.var_2662 = Boolean(parseInt(param1.@PlaceholderWidgetHandler));
         this.var_2661 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "PlaceholderWidgetHandler")
            {
               this.var_2657 = _loc6_;
            }
            else
            {
               this.var_1604[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_809.getValue(param1) == null)
         {
            this.var_809.add(param1,new Map());
         }
         var _loc4_:Map = this.var_809.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_809.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1604[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2657;
         }
         return _loc2_;
      }
