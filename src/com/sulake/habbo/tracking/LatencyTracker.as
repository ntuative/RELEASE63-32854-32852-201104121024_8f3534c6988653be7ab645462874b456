package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1865 = int(this.var_190.getKey("latencytest.interval"));
         this.var_1862 = int(this.var_190.getKey("latencytest.report.index"));
         this.var_2596 = int(this.var_190.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1863 > this.var_1865)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1863 = getTimer();
         this.var_637.add(this.var_1472,this.var_1863);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1472));
         ++this.var_1472;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_637 == null || this.var_229 == null)
         {
            return;
         }
         ...
         if(this.var_229.length == this.var_1862 && this.var_1862 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1864) > this.var_2596 || this.var_1864 == 0)
            {
