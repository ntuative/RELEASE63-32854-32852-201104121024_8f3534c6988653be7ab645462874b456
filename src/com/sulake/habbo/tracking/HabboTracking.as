package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1020:uint = 11;
      ...
      private var var_212:IHabboFriendList;
      
      private var var_1274:IHabboWindowManager;
      
      private var var_170:IHabboToolbar;
      
      private var var_131:IHabboHelp;
      ...
      private var var_277:PerformanceTracker = null;
      
      private var var_460:FramerateTracker = null;
      
      private var var_278:LatencyTracker = null;
      
      private var var_676:LagWarningLogger = null;
      
      private var var_675:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_277 = new PerformanceTracker();
         this.var_460 = new FramerateTracker();
         this.var_278 = new LatencyTracker();
         this.var_676 = new LagWarningLogger();
         this.var_675 = new ToolbarClickTracker(this);
         this.var_1551 = new Array(const_1020);
         var _loc4_:int = 0;
         while(_loc4_ < const_1020)
         {
            this.var_1551[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1713,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1749,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1637,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_907,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1195,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1274)
            {
               this.var_1274.release(new IIDHabboWindowManager());
               this.var_1274 = null;
            }
            if(this.var_318)
            {
            ...
            if(this.var_212)
            {
               if(!this.var_212.disposed)
               {
                  Component(this.var_212).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_212).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_212).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_212).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_212).events.removeEventListener(HabboFriendListTrackingEvent.const_395,this.onFriendlistTrackingEvent);
               }
               this.var_212.release(new IIDHabboFriendList());
               this.var_212 = null;
            }
            if(this.var_131)
            {
               if(!this.var_131.disposed)
               {
                  this.var_131.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_131.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_131.release(new IIDHabboHelp());
               this.var_131 = null;
            }
            if(this.var_170)
            {
               if(!this.var_170.disposed)
               {
                  this.var_170.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_195,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_304,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_297,this.onRoomAction);
               }
            ...
            {
               this.var_325.stop();
               this.var_325.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_325 = null;
            }
      ...
      {
         this.var_1551[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_190 = IHabboConfigurationManager(param2);
         if(this.var_190)
         {
            if(this.var_278 != null)
            {
               this.var_278.configuration = this.var_190;
            }
            if(this.var_277 != null)
            {
               this.var_277.configuration = this.var_190;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1617);
            if(this.var_190)
            {
               if(this.var_676 != null)
               {
                  this.var_676.configure(this.var_190);
               }
               if(this.var_460 != null)
               {
                  this.var_460.configure(this.var_190);
               }
               if(this.var_675 != null)
               {
                  this.var_675.configure(this.var_190);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_785,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_253,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_194,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_657,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_676 != null)
            {
               this.var_676.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_657)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1720);
         }
         else if(param1.type == HabboHotelViewEvent.const_560)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1586);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1512);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_785:
               this.trackLoginStep(HabboLoginTrackingStep.const_1546,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_253:
               this.trackLoginStep(HabboLoginTrackingStep.const_253);
               break;
            ...
            case HabboCommunicationEvent.const_194:
               ...
               this.trackLoginStep(HabboLoginTrackingStep.const_194);
               break;
      ...
      {
         this.var_1274 = IHabboWindowManager(param2);
         if(this.var_1274)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_190)
            {
               if(this.var_190.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_190.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1551)
                  {
                  ...
                  if(this.var_277 != null)
                  {
                     _loc4_["null"] = this.var_277.flashVersion;
                     _loc4_["null"] = this.var_277.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1209);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1209,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_212 = param2 as IHabboFriendList;
         Component(this.var_212).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_212).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_212).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_212).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_212).events.addEventListener(HabboFriendListTrackingEvent.const_395,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_131 = param2 as IHabboHelp;
         this.var_131.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_131.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2818)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1497);
            this.var_2818 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1195,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_907,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_195,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_304,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_297,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_318 = param2 as IAdManager;
         this.var_318.events.addEventListener(AdEvent.const_611,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_170 = param2 as IHabboToolbar;
         this.var_170.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_304)
         {
            if(this.var_2005 < 1)
            {
               if(!this.var_325)
               {
                  this.var_325 = new Timer(60000,1);
                  this.var_325.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_325.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_297)
         {
            if(this.var_325)
            {
               this.var_325.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
            ...
            if(this._connection)
            {
               if(this.var_460)
               {
                  ...
                  if(this._roomEngine)
                  {
                     ...
                     _loc4_ = this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_27) + this._roomEngine.getRoomObjectCount(-1,-1,RoomObjectCategoryEnum.const_25);
                     _loc2_ = "Avatars: " + _loc3_ + ", Objects: " + _loc4_;
                  }
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_460.frameRate),_loc2_));
                  ++this.var_2005;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_675)
         {
            this.var_675.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_190 != null && !Boolean(this.var_190.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_676.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_2003;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2003);
         }
         if(this.var_556 > -1 && _loc2_ - this.var_556 > 15000)
         {
            ++this.var_2004;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2004);
         }
         this.var_556 = _loc2_;
         if(this.var_277 != null)
         {
            this.var_277.update(param1,this.var_556);
         }
         if(this.var_278 != null)
         {
         ...
         if(this.var_460 != null)
         {
            this.var_460.trackUpdate(param1,this,this.var_556);
         }
         if(this.var_676 != null)
         {
            this.var_676.update(this.var_556);
         }
      }
   }
}
