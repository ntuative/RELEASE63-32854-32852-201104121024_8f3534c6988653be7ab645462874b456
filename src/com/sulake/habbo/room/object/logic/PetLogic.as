   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2499)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_187,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1439 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
               _loc2_.setString(RoomObjectVariableEnum.const_149,_loc6_.gesture);
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_793,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1676,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_837,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_187,_loc3_ + this.var_957);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1803;
            _loc2_.setNumber(RoomObjectVariableEnum.const_272,this.var_1803);
            _loc2_.setNumber(RoomObjectVariableEnum.const_149,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1802;
            _loc2_.setNumber(RoomObjectVariableEnum.const_149,this.var_1802);
         }
         else
         {
            this.var_957 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_149,null);
            this.var_1440 = 0;
         }
         if(this.var_1439 > 0)
         {
