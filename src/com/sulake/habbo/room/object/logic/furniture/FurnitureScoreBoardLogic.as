package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_442:int = 50;
      
      private static const const_959:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_719 != _loc2_)
         {
            ...
            if(_loc3_ * const_442 > const_959)
            {
               this.var_1083 = const_959 / _loc3_;
            }
            else
            {
               this.var_1083 = const_442;
            }
            this.var_1365 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_719 && param1 >= this.var_1365 + this.var_1083)
            {
               _loc3_ = param1 - this.var_1365;
               _loc4_ = _loc3_ / this.var_1083;
               _loc5_ = 1;
               if(this.var_719 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1365 = param1 - (_loc3_ - _loc4_ * this.var_1083);
            }
         }
      }
   }
