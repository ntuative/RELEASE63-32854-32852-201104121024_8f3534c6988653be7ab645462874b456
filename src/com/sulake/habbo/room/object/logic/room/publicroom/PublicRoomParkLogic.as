package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1422:String = "goawaybus";
      
      private static const const_1424:String = "bus";
      
      private static const const_1423:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_601,RoomObjectRoomActionEvent.const_491];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1422:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_601,0,_loc4_,_loc5_);
                     break;
                  case const_1424:
                  case const_1423:
