package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1905:int = 255;
      
      private var var_1502:uint = 16777215;
      
      private var var_1906:int = 255;
      
      private var var_1225:uint = 16777215;
      
      private var var_1907:int = 255;
      
      private var var_1226:int = 0;
      
      private var var_1908:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_506,RoomObjectMouseEvent.const_154];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1189,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_858,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_819,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_946,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_895,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1226)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1905;
            if(_loc2_ - this.var_1226 >= this.var_1908)
            {
               _loc3_ = this.var_1225;
               _loc4_ = this.var_1907;
               this.var_1226 = 0;
            }
            else
            {
               _loc7_ = this.var_1502 >> 16 & 255;
               _loc8_ = this.var_1502 >> 8 & 255;
               _loc9_ = this.var_1502 & 255;
               _loc10_ = this.var_1225 >> 16 & 255;
               _loc11_ = this.var_1225 >> 8 & 255;
               _loc12_ = this.var_1225 & 255;
               _loc13_ = (_loc2_ - this.var_1226) / this.var_1908;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1906 + (this.var_1907 - this.var_1906) * _loc13_;
               this._color = _loc3_;
               this.var_1905 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_858,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_723:
               param2.setString(RoomObjectVariableEnum.const_300,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_651:
               param2.setString(RoomObjectVariableEnum.const_289,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_468:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_228)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_941:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1106,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1133:
               param2.setNumber(RoomObjectVariableEnum.const_819,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1194:
               param2.setNumber(RoomObjectVariableEnum.const_946,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_895,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1065,int(param1.bgOnly));
         this.var_1502 = this._color;
         this.var_1906 = this.var_1905;
         this.var_1225 = _loc3_;
         this.var_1907 = _loc4_;
         this.var_1226 = getTimer();
         this.var_1908 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_602,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1459,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1591,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1616,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_602,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_162 || _loc12_ == RoomPlaneData.const_349)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
