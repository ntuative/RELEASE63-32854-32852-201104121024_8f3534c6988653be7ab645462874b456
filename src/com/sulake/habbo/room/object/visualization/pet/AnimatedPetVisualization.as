package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1284:String = "head";
      
      private static const const_618:int = 1;
      
      private static const const_957:int = 1000;
      
      private static const const_1285:String = "pet_experience_bubble_png";
      
      private static const const_1286:int = 0;
      
      private static const const_1287:int = 1;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_887 = [];
         super();
         while(this.var_109.length < ANIMATION_INDEX_COUNT)
         {
            this.var_109.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_109 != null)
         {
            ...
            {
               _loc2_ = this.var_109[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1285) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_336 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_272);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_149);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_272);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_149);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1805 = _loc3_.getNumber(RoomObjectVariableEnum.const_402) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_187);
            if(!isNaN(_loc8_))
            {
               this.var_1622 = _loc8_;
            }
            else
            {
               this.var_1622 = direction;
            }
            this.var_1347 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2151 = _loc3_.getNumber(RoomObjectVariableEnum.const_793);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_837);
            if(_loc9_ != this.var_1621)
            {
               this.var_1621 = _loc9_;
               this.var_2152 = this.var_1621.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_336 != null)
         {
            ...
            if(this.var_1347 > 0)
            {
               _loc2_ = param1 - this.var_1347;
               if(_loc2_ < const_957)
               {
                  this.var_336.alpha = int(Math.sin(_loc2_ / const_957 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_336.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_336.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_262)
         {
            ...
            this.setAnimationForIndex(const_1286,_loc3_);
         }
         if(param2 != this.var_1397)
         {
            this.var_1397 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_90,param2);
            this.setAnimationForIndex(const_1287,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_618;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_109.length)
         {
            return this.var_109[param1];
         }
         return null;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1346 = false;
         var _loc1_:int = this.var_109.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_109[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function updateAnimations(param1:Number) : int
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_109.length)
         {
            _loc5_ = this.var_109[_loc4_];
            if(_loc5_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_109.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_109[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2152);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_618)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_618))
            {
               if(param2 >= FurnitureVisualizationData.const_526.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_526[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1622);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_90,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1284)
            {
               this.var_887[param1] = true;
            }
            else
            {
               this.var_887[param1] = false;
            }
         }
