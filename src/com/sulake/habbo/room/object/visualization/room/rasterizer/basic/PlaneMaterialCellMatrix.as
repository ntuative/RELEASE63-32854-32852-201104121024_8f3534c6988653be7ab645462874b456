package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_807:int = 6;
      
      public static const const_1579:int = const_417;
      ...
      private var var_2235:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2236:Number = -1.0;
      
      private var var_2237:Number = 1.0;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2236 = param6;
         this.var_2237 = param7;
         if(this.var_1661 == const_807)
         {
            this.var_1663 = false;
         }
      }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_343[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_343.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_343[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_343[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_594,param6,param7);
                     return param1;
                  }
                  return this.var_31;
               }
         ...
         {
            _loc11_ = this.var_343[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_594);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_594,this.var_31.width,this.var_594);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_343.length == 1)
         {
            _loc4_ = this.var_343[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
