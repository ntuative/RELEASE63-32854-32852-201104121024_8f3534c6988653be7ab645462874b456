package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_816:WallAdRasterizer;
      
      private var var_539:LandscapeRasterizer;
      
      private var var_815:PlaneMaskManager;
      ...
      public function RoomVisualizationData()
      {
         ...
         this.var_816 = new WallAdRasterizer();
         this.var_539 = new LandscapeRasterizer();
         this.var_815 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc9_ = _loc4_[0];
            this.var_816.initialize(_loc9_);
         }
         ...
         {
            _loc11_ = _loc6_[0];
            this.var_815.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_815.initializeAssetCollection(param1);
         this.var_706 = true;
      }
