package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1553:int = 13421772;
      
      private static const const_1004:int = 16777215;
      
      private static const const_1005:int = 13421772;
      
      private static const const_1002:int = 10066329;
      
      private static const const_1003:int = 10066329;
      
      public static const const_1521:int = 16777215;
      
      public static const const_1550:int = 13421772;
      
      public static const const_1649:int = 10066329;
      ...
      private var var_2696:String = null;
      
      private var var_1233:uint = 16777215;
      
      private var var_2694:int = 255;
      
      private var var_2698:int = 255;
      ...
      private var var_1616:int = -1000;
      
      private const const_2079:int = 250;
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_116 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1189);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1230);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_216,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_162)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_116,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
               ...
               {
                  _loc13_.color = const_1003;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1004;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1005;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_349)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1618)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_116,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_349)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1616 + this.const_2079 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_378.length)
            {
               _loc11_ = this.var_654[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_378[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1914)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2693 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2698 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2694 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1983)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1542 || _loc3_.y != this.var_2697 || _loc3_.z != this.var_2699 || param1.scale != this.var_2695))
            {
               this.var_1542 = _loc3_.x;
               this.var_2697 = _loc3_.y;
               this.var_2699 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1106);
            if(_loc3_ != this.var_2696)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2696 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_858));
            if(_loc4_ != this.var_1233)
            {
               this.var_1233 = _loc4_;
               this.var_2693 = this.var_1233 & 255;
               this.var_2698 = this.var_1233 >> 8 & 255;
               this.var_2694 = this.var_1233 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1065));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_172 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_289);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_300);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_317);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_819));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_946));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_895));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_130.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_216 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_116 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_378;
         if(this.var_378.length == 0)
         {
            _loc6_ = this.var_130;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_378.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_216)
                        {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_378.push(_loc12_);
                        this.var_654.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1690;
      }
         ...
         while(_loc8_ < this.var_536.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_130.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_116 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_116 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_228)
                              {
