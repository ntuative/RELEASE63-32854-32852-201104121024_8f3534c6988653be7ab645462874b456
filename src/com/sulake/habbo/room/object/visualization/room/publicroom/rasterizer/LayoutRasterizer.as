package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_758:IGraphicAssetCollection;
      
      private var var_1981:XMLList;
      
      private var _offsetX:int;
      
      private var var_1119:int;
      
      private var var_2644:Vector3d;
      ...
      private var var_1498:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_994)
         {
            this.var_994 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1498 = this.var_44.getValue(this.var_994);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2644 = new Vector3d(-0.5,0.5,0);
         this.var_995 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2644);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_994);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1892 = RoomObjectVariableEnum.const_1073;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1892 = RoomObjectVariableEnum.const_1235;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1217 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1217 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_994);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2643 && param3 == this.var_2645)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1217 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1217 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1892);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_528;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      {
         var _loc10_:* = null;
         if(this.var_1498 == null)
         {
            return;
         }
         var _loc5_:XMLList = this.var_1498.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_758.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_437.indexOf(_loc10_) >= 0 && this.var_995)
            {
               param1 = this.var_437.indexOf(_loc10_);
               if(this.var_652[param1] != "")
               {
                  _loc9_ = this.var_758.getAsset(this.var_652[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_651[param1] != -1)
               {
                  param2.alpha = this.var_651[param1];
               }
               this.var_437.splice(param1,1);
               this.var_652.splice(param1,1);
               this.var_651.splice(param1,1);
      ...
      public function exchangeElementGraphics(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ < 0)
         {
            ...
            this.var_652.push(param2);
            this.var_651.push(-1);
         }
         else
         {
            this.var_652[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_437.push(param1);
            this.var_652.push("");
            this.var_651.push(param2);
         }
         else
         {
            this.var_651[_loc3_] = param2;
         }
      }
   }
}
