package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationStateData
   {
      ...
      {
         if(param1 >= 0 && param1 < this.var_689)
         {
