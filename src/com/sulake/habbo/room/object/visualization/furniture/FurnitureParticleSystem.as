package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_780.alphaMultiplier = 1;
         this.var_1454 = new ColorTransform();
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_1184)
         {
            _loc1_.dispose();
         }
         this.var_1184 = null;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_98 = this.var_1184[param1];
         this.var_970 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1825 >= 0)
         {
            this.var_263 = this._visualization.getSprite(this.var_1825);
            if(this.var_263 && this.var_263.asset)
            {
               ...
               if(this.var_86 == null)
               {
                  this.var_86 = this.var_263.asset.clone();
                  if(this.var_780.alphaMultiplier != 1)
                  {
                     this.var_634 = new BitmapData(this.var_86.width,this.var_86.height,true,4278190080);
                  }
               }
               this.var_2541 = -this.var_263.offsetX;
               this.var_2540 = -this.var_263.offsetY;
               this.var_263.asset = this.var_86;
            }
            if(this.var_86)
            {
            ...
            if(this.var_634)
            {
               this.var_634.fillRect(this.var_634.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_98.y * this.var_1183;
         }
         return 0;
      }
      ...
      public function updateSprites() : void
      {
         ...
         if(this.var_86 && this.var_263.asset != this.var_86)
         {
            this.var_263.asset = this.var_86;
         }
         if(this.var_970)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_970 && this.var_98.hasIgnited)
         {
            this.var_970 = true;
         }
         _loc8_ = this.var_1119 * this.var_1183;
         this.var_98.update();
         if(this.var_970)
         {
            if(this.var_98.roomObjectSpriteId >= 0)
            ...
            {
               this.var_86.draw(this.var_634,this.var_1824,this.var_780,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_98.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2541 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1183;
               _loc4_ = this.var_2540 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1183;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1454.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_86.draw(_loc7_,this._translationMatrix,this.var_1454,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         this.var_1119 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1183 = this.var_2542 / 64;
         this.var_847 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_847 = Math.min(this.var_847,1);
         this.var_780.alphaMultiplier = this.var_847;
