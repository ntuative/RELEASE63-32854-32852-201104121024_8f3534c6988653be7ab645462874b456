package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1608:String = "cone";
      
      public static const const_1474:String = "plane";
      
      public static const const_1601:String = "sphere";
      ...
      private var var_889:Number = 0.1;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_338)
         {
            _loc1_.dispose();
         }
         this.var_338 = null;
      ...
      public function reset() : void
      {
         ...
         this.var_890 = 0;
         this.var_970 = false;
         this.init(0,0,0,this._direction,this.var_2183,this.var_889,this.var_2182,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1092.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_970 = true;
         if(this.var_890 < this.var_1353)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2181)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_889,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_338.push(_loc4_);
            ++this.var_890;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1092.length);
         return this.var_1092[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_890 < this.var_1353)
         {
            if(this.age % this.var_2180 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_890 < this.var_1353)
         {
            ...
            this.y = (2 - this.var_245) * this.y - (1 - this.var_245) * this.lastY + this.var_1634 * this.var_889 * this.var_889;
         ...
         var _loc1_:* = [];
         for each(_loc2_ in this.var_338)
         {
            _loc2_.update();
            _loc3_ = _loc2_.x;
            _loc4_ = _loc2_.y;
            ...
            _loc2_.y = (2 - this.var_245) * _loc2_.y - (1 - this.var_245) * _loc2_.lastY + this.var_1634 * this.var_889 * this.var_889;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_338.splice(this.var_338.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
