package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_256 == null && spriteCount > 0)
         {
         ...
         if(this.var_256 != null)
         {
            ...
            {
               _loc2_ = this.var_256[_loc3_];
               _loc2_.update(this._offsetArray,this.var_2359,param1);
               _loc3_++;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1057);
