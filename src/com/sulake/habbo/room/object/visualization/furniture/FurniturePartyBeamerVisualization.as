package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_442:int = 2;
      
      private static const const_1012:int = 15;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_829[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_829[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_829.length == 2)
            {
               return this.var_829[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_829.length == 2)
            {
               return this.var_829[param3 - 2].y;
            }
         }
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc6_:Number = this.var_1253[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1012;
         }
         ...
         if(int(_loc9_) == 0)
         {
            this.var_1253[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1255.push(const_1421);
         this.var_1255.push(const_1420);
         this.var_1253 = new Array();
         this.var_1253.push(this.getRandomAmplitudeFactor());
         this.var_1253.push(this.getRandomAmplitudeFactor());
      }
