package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_621:String = "temporary_room";
      
      private static const const_351:int = -1;
      
      private static const const_622:String = "room";
      
      private static const const_962:int = -2;
      
      private static const const_1306:String = "tile_cursor";
      
      private static const const_961:int = -3;
      
      private static const const_1305:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_350:String = "object_icon_sprite";
      
      private static const const_435:int = 15;
      ...
      private var var_896:IRoomRendererFactory = null;
      
      private var var_722:IRoomObjectFactory = null;
      
      private var var_555:IRoomObjectVisualizationFactory = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_722.release(new IIDRoomObjectFactory());
            this.var_722 = null;
         }
         if(this.var_555 != null)
         {
            this.var_555.release(new IIDRoomObjectVisualizationFactory());
            this.var_555 = null;
         }
         ...
         {
            this.var_896.release(new IIDRoomRendererFactory());
            this.var_896 = null;
         }
         ...
         if(this.var_299 != null)
         {
            ...
            {
               _loc2_ = this.var_299.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_299.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_299.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_96,this.var_97));
      ...
      {
         this.var_1100 = false;
         if(this.var_491 && this.var_491.length > 0)
         {
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = this.var_491.indexOf(param2);
         if(_loc3_ == -1)
         {
            this.var_491.push(param2);
            this.var_1100 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_897 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_299.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_96 || _loc6_ != this.var_97 || !this.var_1099)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_670) - 0.5;
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_948) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_755) + 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_685) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_722 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_555 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_555;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_25);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_34);
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_308);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_896 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_898 != null)
            {
               this.var_898.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_929,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_149);
         }
         this.var_2215 = this.var_149.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_929)
         {
            this.var_2216 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_318.events.addEventListener(AdEvent.const_611,this.showRoomAd);
         this.var_318.events.addEventListener(AdEvent.const_724,this.onRoomAdImageLoaded);
         this.var_318.events.addEventListener(AdEvent.const_681,this.onRoomAdImageLoaded);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_722 != null)
         {
            this.var_722.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_722 == null || this.var_555 == null || this._roomManager == null || this.var_896 == null || this._communication == null || this.var_149 == null || !this.var_2216)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_492 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_736,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_341.length)
            {
               _loc3_ = this.var_341.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1246,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_471,param1,param2));
            }
            else
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1246);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_492)
         {
            _loc5_ = this.var_341.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_341.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_304,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_351,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1147,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1220,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_351,const_622,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_863,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_734,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_670,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_755,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_948,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_685,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1230,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_723,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_300,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_651,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_289,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_751,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_317,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_468,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_228);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_795,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_668,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_795,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_668,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1183,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1085,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_962,const_1306,RoomObjectCategoryEnum.const_308);
         if(this.var_149.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_961,const_1305,RoomObjectCategoryEnum.const_308);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_351,RoomObjectCategoryEnum.const_79);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc10_ = this.var_341.getValue(_loc9_);
            if(_loc10_ == null)
            {
               _loc10_ = new RoomData(param1,param2,null);
               this.var_341.add(_loc9_,_loc10_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_723,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_651,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         if(param5 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_751,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1697,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1194,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1133,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_299.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_297,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_896.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1178;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_734);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_795);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_668);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1183);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1085);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1368;
         var _loc9_:int = param3 - this.var_1367;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1099 = true;
               this.var_720 = false;
               this.var_2217 = this.var_1368;
               this.var_2218 = this.var_1367;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_1099)
            {
               ...
               if(this.var_720)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_96,this.var_97);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1099)
            {
               if(!this.var_720)
               {
                  _loc8_ = param2 - this.var_2217;
                  _loc9_ = param3 - this.var_2218;
                  if(_loc8_ <= -const_435 || _loc8_ >= const_435 || _loc9_ <= -const_435 || _loc9_ >= const_435)
                  {
                     this.var_720 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_350);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_515,this.var_96,this.var_97,-1,RoomObjectCategoryEnum.const_169));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_75 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_351,const_622);
                     this.var_75.handleRoomObjectEvent(_loc14_,this.var_96,this.var_97);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         else if(this.var_13 != null)
         {
            ...
            else if(param2 == RoomObjectCategoryEnum.const_25)
            {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1366);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_350);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_350,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1368 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1367 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1366);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_350);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1366);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_350);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_75 != null)
         {
            return this.var_75.modifyRoomObject(this.var_96,this.var_97,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_75 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_25)
            {
               return this.var_75.modifyWallItemData(this.var_96,this.var_97,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_75 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_25)
            {
               return this.var_75.deleteWallItem(this.var_96,this.var_97,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(this.var_75 != null)
         {
            return this.var_75.initializeRoomObjectInsert(this.var_96,this.var_97,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_75 != null)
         {
            this.var_75.cancelRoomObjectInsert(this.var_96,this.var_97);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_961,RoomObjectCategoryEnum.const_308);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_962,RoomObjectCategoryEnum.const_308);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_225,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_345,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_425,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_880,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1254,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1079,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_404,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_225,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_345,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_425,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1178,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_404,param1,param2,param3,RoomObjectCategoryEnum.const_25));
         }
         var _loc9_:ISelectedRoomObjectData = this.getPlacedObjectData(param1,param2);
         if(_loc9_ && _loc9_.id == param3 && _loc9_.category == RoomObjectCategoryEnum.const_25)
         {
            this.selectRoomObject(param1,param2,param3,RoomObjectCategoryEnum.const_25);
         }
         return true;
      }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1059) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1255);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_468,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_941,_loc5_);
                  }
               }
            }
         }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_25);
      }
      ...
      public function disposeObjectWallItem(param1:int, param2:int, param3:int) : void
      {
         ...
         this.disposeObject(this.getRoomIdentifier(param1,param2),param3,RoomObjectCategoryEnum.const_25);
         this.updateObjectRoomWindow(param1,param2,param3,false);
         this.removeBtnMouseCursorOwner(RoomObjectCategoryEnum.const_25,param3);
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_404,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_187);
         }
      ...
      private function getObject(param1:String, param2:int, param3:int) : IRoomObjectController
      {
         ...
         if(_loc5_ == null)
         {
            ...
            else if(param3 == RoomObjectCategoryEnum.const_25)
            {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_845,this.var_96,this.var_97,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_75 != null)
         {
            this.var_75.handleRoomObjectEvent(param1,this.var_96,this.var_97);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_25:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_347);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_349,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_300,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_289,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_317,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_468,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_492 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_621);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_621,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_721.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_25:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_225,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_347,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_837,int(param2));
               }
               break;
         ...
         {
            this.var_1101.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1080,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_721.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_96,this.var_97,const_351,RoomObjectCategoryEnum.const_79,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_621);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1080);
               ...
               this.var_721.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1101.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(param3 == RoomObjectCategoryEnum.const_25)
         {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_392,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1073,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1235,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1144,RoomObjectVariableEnum.const_392,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_318.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_724:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1128,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_681:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1069,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
