package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_929:String = "RCL_LOADER_READY";
      
      private static const const_358:String = "RCL_PUBLICROOM_";
      
      private static const const_1799:int = 0;
      
      private static const const_1010:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_441:String = "place_holder";
      
      private static const const_642:String = "wall_place_holder";
      
      private static const const_640:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_441;
      
      private static const const_641:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1009:String = "selection_arrow";
      ...
      private var var_1024:Map = null;
      
      private var var_447:Dictionary;
      
      private var var_1025:Map = null;
      
      private var var_209:PublicRoomData = null;
      
      private var var_1522:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2733 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_1010)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2734 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2731 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2732 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_405.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_544.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_544.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_446.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_446.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_447)
            {
               delete this.var_447[_loc1_];
            }
            this.var_447 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_823.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_659.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_660.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_660.remove(_loc7_);
               this.var_660.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2730)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_929));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_545 != null)
         {
            this.var_545.remove(param1);
            this.var_545.add(param1,param2);
         }
         if(this.var_546 != null)
         {
            this.var_546.remove(param2);
            this.var_546.add(param2,param1);
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_25;
         }
         if(this.var_447[param1] != null)
         {
         ...
         {
            return RoomObjectCategoryEnum.const_308;
         }
         return RoomObjectCategoryEnum.const_169;
      }
      ...
      {
         return [const_441,const_642,const_640,const_641,TILE_CURSOR,const_1009];
      }
      ...
      {
         var _loc3_:String = this.var_659.getValue(param1) as String;
      ...
      {
         return this.var_1024.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1025[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_659.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_823.getValue(param1) != null)
         {
            return this.var_823.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_209 != null && this.var_209.hasWorldType(const_358 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_281 || param1 == RoomObjectVisualizationEnum.const_70 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_25)
         {
            if(param1.indexOf("poster") == 0)
            {
               param1 = "poster";
            }
            return int(this.var_660.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2732 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_364,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1522.getValue(param1) != null)
         {
            this.var_209 = this.var_1522.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_688,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2733.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1487);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_447[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_364,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_612,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_447[param1];
            this.var_1025.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1522.add(param1,_loc4_);
         this.var_209 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_824.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_824.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_544.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_824.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_544.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_544.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_555.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_446.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_446.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_446[_loc2_] != null)
         {
            _loc3_ = this.var_446.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_358 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_358 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_209.getWorldHeightScale(const_358 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_209 != null)
         {
            return this.var_209.getWorldScale(const_358 + param1);
         }
         return 32;
      }
