   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_345);
         ...
         _loc9_ = this._container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_25);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            _loc8_ = this._container.roomEngine.getRoomObjectWithIndex(_loc1_,_loc2_,_loc4_,RoomObjectCategoryEnum.const_25);
            if(_loc8_ != null)
            {
               ...
               _loc3_.push(new ChooserItem(_loc8_.getId(),RoomObjectCategoryEnum.const_25,_loc7_));
            }
            _loc4_++;
         }
         _loc3_.sort(this.compareItems);
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_728,_loc3_,this._container.sessionDataManager.isAnyRoomController));
      }
