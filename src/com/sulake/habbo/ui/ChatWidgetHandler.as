package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_670:Map = null;
      
      private var var_1982:Map = null;
      ...
      private var var_832:Point = null;
      
      private var var_554:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1259 = [];
         this.var_554 = new Vector3d();
         super();
         this.var_455 = new Map();
         this.var_322 = new Map();
         this.var_670 = new Map();
         this.var_1982 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_455 != null)
         {
            ...
            {
               _loc2_ = this.var_455.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_322 != null)
         {
            ...
            {
               _loc2_ = this.var_322.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_555,RoomWidgetChatSelectAvatarMessage.const_748];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_555:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1257))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1257))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_748:
      ...
      {
         return [RoomSessionChatEvent.const_196];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_196:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_192)
                           {
                              _loc13_ = this.var_322.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_455.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_670.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_192:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_670.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_87,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_670.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_192)
                                    {
                                       this.var_322.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_455.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1258 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1258);
            }
            if(this.var_832 == null)
            {
               ...
               this.var_554.y = 0;
               this.var_554.z = 0;
               this.var_832 = _loc4_.getScreenPoint(this.var_554);
               this.var_1258 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_554.x = 0;
            this.var_554.y = 0;
            this.var_554.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_554);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_832.x || _loc8_.y != this.var_832.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_832,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_322)
         {
            _loc2_ = this.var_322.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_455)
         {
            _loc2_ = this.var_455.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1259.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_87,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_670.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1982.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1982.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_322)
            {
               this.var_322.add(_loc3_,param2);
            }
         }
      }
   }
