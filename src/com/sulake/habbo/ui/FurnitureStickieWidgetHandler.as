package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_717,RoomWidgetStickieSendUpdateMessage.const_813,RoomWidgetStickieSendUpdateMessage.const_482];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_717:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1204);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_482:
               ...
               {
                  this._container.roomEngine.modifyRoomObjectData(_loc4_.objectId,RoomObjectCategoryEnum.const_25,_loc4_.colorHex + " " + _loc4_.text);
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_813:
               ...
               if(this._container != null && this._container.roomEngine != null)
               {
                  this._container.roomEngine.deleteRoomObject(_loc5_.objectId,RoomObjectCategoryEnum.const_25);
               }
               break;
         }
         return null;
