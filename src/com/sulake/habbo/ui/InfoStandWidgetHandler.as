   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_174,this.onFigureUpdate);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_174,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_641.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_641.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_926);
         _loc1_.push(RoomWidgetUserActionMessage.const_847);
         _loc1_.push(RoomWidgetUserActionMessage.const_745);
         _loc1_.push(RoomWidgetUserActionMessage.const_888);
         _loc1_.push(RoomWidgetUserActionMessage.const_865);
         _loc1_.push(RoomWidgetUserActionMessage.const_609);
         _loc1_.push(RoomWidgetUserActionMessage.const_703);
         _loc1_.push(RoomWidgetUserActionMessage.const_835);
         _loc1_.push(RoomWidgetUserActionMessage.const_814);
         _loc1_.push(RoomWidgetUserActionMessage.const_892);
         _loc1_.push(RoomWidgetUserActionMessage.const_676);
         _loc1_.push(RoomWidgetFurniActionMessage.const_240);
         _loc1_.push(RoomWidgetFurniActionMessage.const_656);
         _loc1_.push(RoomWidgetFurniActionMessage.const_911);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_909);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_672);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_721);
         _loc1_.push(RoomWidgetUserActionMessage.const_494);
         _loc1_.push(RoomWidgetUserActionMessage.const_707);
         _loc1_.push(RoomWidgetUserActionMessage.const_472);
         _loc1_.push(RoomWidgetUserActionMessage.const_1729);
         _loc1_.push(RoomWidgetPetCommandMessage.const_585);
         _loc1_.push(RoomWidgetPetCommandMessage.const_904);
         _loc1_.push(RoomWidgetUserActionMessage.const_493);
         _loc1_.push(RoomWidgetUserActionMessage.const_369);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_494)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_369 || param1.type == RoomWidgetUserActionMessage.const_493 || param1.type == RoomWidgetUserActionMessage.const_472)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_926:
               this._container.friendList.askForAFriend(_loc2_,_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_847:
            ...
            case RoomWidgetUserActionMessage.const_745:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_919,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_888:
               ...
               break;
            case RoomWidgetUserActionMessage.const_865:
            ...
            case RoomWidgetUserActionMessage.const_703:
               ...
               break;
            case RoomWidgetUserActionMessage.const_835:
               this._container.roomSession.assignRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_814:
               this._container.roomSession.removeRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_892:
            ...
            case RoomWidgetUserActionMessage.const_369:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_909:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_672:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_721:
               ...
               break;
            case RoomWidgetUserActionMessage.const_494:
               this._container.roomSession.kickBot(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_707:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_311);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_492) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_492);
               }
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_345);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1254);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1079);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_932)
                  {
                     _loc31_ = this.var_71.getRoomItemPlaylist();
                     if(_loc31_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_366) == 0)
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_366.length);
                     _loc27_ = parseInt(_loc32_);
                     _loc30_ = "null";
                  }
                  if(_loc27_ != -1)
                  {
                     _loc33_ = this.var_71.getSongInfo(_loc27_);
                     if(_loc33_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_192)
               {
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_831)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_603);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_121)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_110)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_947);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_841;
                  }
                  if(!_loc36_)
                  {
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1665);
               }
               else
               {
               ...
               _loc20_ = _loc13_.sex;
               _loc21_ = this._container.avatarRenderManager.createAvatarImage(_loc19_,AvatarScaleType.const_54,_loc20_);
               if(_loc21_ != null)
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_133];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_133:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_641.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_641.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_947);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_71 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_71.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_412,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_71 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_426,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
