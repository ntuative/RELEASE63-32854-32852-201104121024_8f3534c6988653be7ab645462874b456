package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_760,RoomWidgetViralFurniMessage.const_838,RoomWidgetViralFurniMessage.const_168];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_760:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_838:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_453,RoomSessionViralFurniStatusEvent.const_454];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_453:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_664);
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_454:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
