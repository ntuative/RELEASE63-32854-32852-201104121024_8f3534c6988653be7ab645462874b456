package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_814 = [];
         this.var_814.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_814.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_814)
         {
            return;
         }
         for each(_loc1_ in this.var_814)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_836);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_648);
         return _loc1_;
      }
