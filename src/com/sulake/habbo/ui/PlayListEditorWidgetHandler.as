package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1402:IMessageEvent;
      
      private var var_1722:IMessageEvent;
      
      private var var_1723:IMessageEvent;
      ...
      {
         return RoomWidgetEnum.const_584;
      }
      ...
      {
         this.var_1402 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1722 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1723 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1402);
         this._connection.addMessageEvent(this.var_1722);
         this._connection.addMessageEvent(this.var_1723);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1402);
         this._connection.removeMessageEvent(this.var_1722);
         this._connection.removeMessageEvent(this.var_1723);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_801,RoomWidgetPlayListModificationMessage.const_799,RoomWidgetPlayListModificationMessage.const_753,RoomWidgetPlayListPlayStateMessage.const_658,RoomWidgetPlayListUserActionMessage.const_652];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_801:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_781,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_799:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_753:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_658:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_652:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_235:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_810,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_650,-1));
            }
         }
      }
   }
