   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_303,this.onFigureUpdate);
            }
            if(this._inventory && !this._inventory.disposed && this._inventory.events)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_910,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_732,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_170 && !this.var_170.disposed && this.var_170.events)
            {
               this.var_170.events.removeEventListener(HabboToolbarEvent.const_73,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_533,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_303,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_910,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_732,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_533,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1580)
            {
               ...
               this.var_1580 = _loc2_;
               this.var_2051 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_2051;
            }
         }
         if(this.var_170 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1174,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_170.events.dispatchEvent(_loc5_);
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_777);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_942);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_740);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_774);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_859);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_770);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_429);
         _loc1_.push(RoomWidgetStopEffectMessage.const_854);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1678);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1113);
         _loc1_.push(RoomWidgetToolbarMessage.const_833);
         _loc1_.push(RoomWidgetToolbarMessage.const_733);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_427);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1625);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1070);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_832);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_826);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_752);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1534);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_878);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_699);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_943);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_383);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_857:
               ...
               break;
            case RoomWidgetDanceMessage.const_777:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_942:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_740:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_774:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_429:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1171)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_199,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_770:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1250:
                        this._catalog.openCatalogPage(CatalogPageName.const_1576,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1249:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_332);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1686:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1456:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_859:
            case RoomWidgetStopEffectMessage.const_854:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1113:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_832:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_833:
               ...
               if(this.var_170)
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_733:
               ...
               {
                  this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_523,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_427:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_752:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_367,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_878:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_367,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_699:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_367,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_943:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_450));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_383:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_659));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_860));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_533:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_529));
         }
      }
