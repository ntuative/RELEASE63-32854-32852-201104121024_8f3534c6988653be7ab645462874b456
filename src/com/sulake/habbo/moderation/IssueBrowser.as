package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2054:String = "open_issues";
      
      private const const_2056:String = "picked_issues";
      
      private const const_2087:String = "closed_issues";
      ...
      private var var_357:IIssueBrowserView;
      
      private var var_1786:IIssueBrowserView;
      
      private var var_1785:IIssueBrowserView;
      
      private var var_1787:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_357.view.width = this.var_258.container.width;
         this.var_357.view.height = this.var_258.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2055:
               ...
               {
                  this.var_1786 = new MyIssuesView(this.issueManager,this,this.var_258.container);
               }
               return this.var_1786;
            case this.const_2054:
               if(this.var_1785 == null)
               {
                  this.var_1785 = new OpenIssuesView(this.issueManager,this,this.var_258.container);
               }
               return this.var_1785;
            case this.const_2056:
               if(this.var_1787 == null)
               {
                  this.var_1787 = new PickedIssuesView(this.issueManager,this,this.var_258.container);
               }
