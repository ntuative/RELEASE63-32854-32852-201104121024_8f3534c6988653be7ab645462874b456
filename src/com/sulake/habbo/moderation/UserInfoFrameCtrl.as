package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1229:UserInfoCtrl;
      ...
      public function show() : void
      {
         ...
         this.var_1229 = new UserInfoCtrl(this._frame,this.var_34,"",true);
         this.var_1229.load(this._frame.content,this._userId);
         this._frame.visible = true;
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1664;
      }
