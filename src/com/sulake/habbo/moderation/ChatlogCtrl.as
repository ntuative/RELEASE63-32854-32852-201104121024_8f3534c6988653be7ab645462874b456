package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_884:Array = [];
      
      private static var var_1620:int = 1000;
      ...
      private var var_1619:IMessageComposer;
      ...
      private var var_708:IWindowContainer;
      ...
      {
         this.var_708 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_707 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1619);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_884.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_707.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_884.length < var_1620)
         {
            ...
            param1.width = this.var_707.width;
            param1.height = this.var_707.height;
            var_884.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1343.getValue(param2.chatterName))
            {
               this.var_1343.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1343.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1342)
         {
