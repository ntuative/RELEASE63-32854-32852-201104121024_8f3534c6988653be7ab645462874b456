package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_763:IssueMessageData = null;
      
      private var var_762:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2424 = param2.method_1;
         this.var_2423 = param2.pickerUserName;
         this.var_1505 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1158 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1159;
         }
         if(this.var_763 == null || param1.timeStamp < this.var_763.timeStamp)
         {
            this.var_763 = param1;
         }
         if(this.var_762 == null || param1.priority > this.var_762.timeStamp)
         {
            this.var_762 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_762;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_763;
         if(_loc2_ == null)
         {
