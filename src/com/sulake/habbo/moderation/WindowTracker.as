package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1251:int = 3;
      
      public static const const_850:int = 4;
      
      public static const const_1258:int = 5;
      
      public static const const_1748:int = 6;
      
      public static const const_1525:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1687:int = 9;
       
      
      private var var_1962:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1962 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1962[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1962[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
