package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1011:Array = [];
      ...
      {
         this.var_812 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1748;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1011.pop() as IWindowContainer;
         }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1512)
         {
