package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_151:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_482:UserInfoCtrl;
      
      private var var_1090:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_151.getHighestPriorityIssue();
         this.var_482 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_1090 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_482.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_151.reportedUserId > 0)
         {
            this.var_1090.load(_loc4_,this.var_151.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_151.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_151.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_65 != null && this.var_65.issueManager != null && this.var_151 != null)
         {
            this.var_65.issueManager.removeHandler(this.var_151.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_151.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_151.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_151.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.releaseBundle(this.var_151.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_151.getHighestPriorityIssue().issueId;
         this.var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_65,WindowTracker.const_1251,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_151.getHighestPriorityIssue();
            this.var_482 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
            this.var_482.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
