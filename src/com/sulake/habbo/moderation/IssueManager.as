package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1201:String = "issue_bundle_open";
      
      public static const const_790:String = "issue_bundle_my";
      
      public static const const_1044:String = "issue_bundle_picked";
      
      public static const const_1457:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_880 = new Map();
         this.var_580 = new IssueBrowser(this,this.var_65.windowManager,this.var_65.assets);
         this.var_1075 = [];
         this.var_1076 = [];
         this.var_881 = new Map();
         this.var_2132 = parseInt(this.var_65.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1610 = new Timer(const_1457,0);
         this.var_1610.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1610.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1075 = this.var_1075.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_163 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_405 && _loc3_.method_1 == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1076 = this.var_1076.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_65.soundManager.playSound(HabboSoundTypesEnum.const_1148);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_880.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_880.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1674)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_102)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_880.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2133++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_880.add(param1.issueId,_loc2_);
         ...
         if(this.var_1075.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_65.sessionDataManager.userId;
            if(_loc5_ != param1.method_1)
            {
               if(param1.state == IssueMessageData.const_405)
               {
                  this.unhandleBundle(_loc3_.id);
               }
            }
         }
         if(param1.state == IssueMessageData.const_163)
         {
            _loc6_ = this.getBundles(const_790);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1076.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2132);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_881.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_881.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_880.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_102.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_102)
         {
            ...
            {
               case const_1201:
                  if(_loc4_.state == IssueMessageData.const_163)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_790:
                  if(_loc4_.state == IssueMessageData.const_405 && _loc4_.method_1 == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_881.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_881.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      private function validateBundle(param1:IssueBundle, param2:IssueMessageData, param3:Boolean = false) : Boolean
      {
         ...
         if(!param3)
         {
            ...
            if(param1.method_1 != param2.method_1)
            {
               return false;
            }
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_405 && _loc5_.method_1 == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_881.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
