package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1284:Number = 1.0;
      
      private var var_678:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1284,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1041);
         }
      ...
      {
         return int(this.var_1682 * (Number(param1 - this._minValue) / (this.var_1284 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1682 * (this.var_1284 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1042)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_182)
            {
               this.var_1042 = false;
            }
         }
         if(!this.var_1042 || param1.type != WindowEvent.const_226)
         {
            return;
         }
         if(this.var_678 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_678) * this.var_678;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_678 != 0)
            {
               _loc3_ = this.var_1041 + this.var_678;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_740 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_740.width,this.var_740.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_740,this.var_740.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_741 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_741.width,this.var_741.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_741,this.var_741.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1682 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_740 = BitmapData(_loc2_.content);
