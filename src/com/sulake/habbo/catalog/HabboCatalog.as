package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_623:uint = 1;
      ...
      private var var_1105:IRoomSession;
      ...
      private var var_499:IAvatarRenderManager;
      ...
      private var var_174:CatalogViewer;
      
      private var var_342:ICatalogNavigator;
      
      private var var_104:Purse;
      
      private var var_92:RecyclerLogic;
      
      private var var_132:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_221:PurchaseConfirmationDialog;
      
      private var var_300:ChargeConfirmationDialog;
      ...
      private var var_2225:GiftWrappingConfiguration;
      
      private var var_1104:ClubGiftController;
      
      private var var_493:ClubBuyController;
      
      private var var_731:Map;
      
      private var var_1103:Boolean = false;
      
      private var var_903:IPurchasableOffer;
      
      private var var_1370:IDragAndDropDoneReceiver;
      
      private var var_85:PlacedObjectPurchaseData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_499)
         {
            this.var_499.release(new IIDAvatarRenderManager());
            this.var_499 = null;
         }
         if(this.var_190)
         {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_88,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_221 == null)
            {
               this.var_221 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_221.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_493.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_499 = param2 as IAvatarRenderManager;
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_342.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_190.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_190.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_405.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_405.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = this.var_405.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_731.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_104.getActivityPointsForType(Purse.const_206)));
         var _loc1_:int = 0;
      ...
      {
         this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_706)
         {
            if(!this.var_405.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.var_170 != null && _loc2_)
         {
            this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_174.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_342 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_174 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_174.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_623) as IWindowContainer;
         ...
         _loc3_.setParamFlag(WindowParam.const_249,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1654 = param1.session.isPrivateRoom;
               this.var_1105 = param1.session;
               if(this.var_92 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_132 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1104 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_493 == null)
         {
            this.var_493 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_174 != null)
         {
            this.var_174.catalogWindowClosed();
         }
         if(this.var_92 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_92.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_342.buildCatalogIndex(_loc2_);
         if(this.var_732 && this.var_732 != "")
         {
            this.var_342.openPage(this.var_732);
            this.var_732 = "";
            this.var_902 = -1;
         }
         else if(this.var_902 > -1)
         {
            this.var_342.openPageById(this.var_902,this.var_1653);
            this.var_902 = -1;
            this.var_1653 = -1;
            this.var_732 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_174.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_174.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2227 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1094);
         }
         this.var_2227 = false;
         if(this.var_300 != null)
         {
            this.var_300.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_68,this.var_104.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2226 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1233);
         }
         this.var_2226 = false;
         if(this.var_300 != null)
         {
         ...
         if(_loc2_.type == Purse.const_206)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1104.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_174.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_132 != null)
         {
            this.var_132.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_132 != null)
         {
            this.var_132.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_132 != null)
         {
            this.var_132.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2225 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_221 != null)
         {
            this.var_221.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_132.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_300 == null)
         {
            this.var_300 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_300.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_731.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_731.add(_loc2_.productCode,_loc3_.slice());
            this.var_174.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_190.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_190.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_180)
         {
            _loc3_ = this.var_190.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_190.keyExists("catalog.drag_and_drop") || this.var_190.getKey("catalog.drag_and_drop") != "true")
         {
            return;
         }
         if(!this.var_1105 || !this.var_1105.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1103 && param1.type == RoomEngineObjectEvent.const_165)
         {
            this.resetPlacedOfferData();
            if(this.var_903 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_85 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_903);
            _loc2_ = this.var_1370;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_903.productContainer.firstProduct;
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_326,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_85 != null)
         {
            if(this.var_85.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_85.roomId,this.var_85.roomCategory,this.var_85.objectId);
            }
            else if(this.var_85.category == RoomObjectCategoryEnum.const_25)
            {
               this._roomEngine.disposeObjectWallItem(this.var_85.roomId,this.var_85.roomCategory,this.var_85.objectId);
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_85.objectId,this.var_85.category);
            }
            this.var_85.dispose();
            this.var_85 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(this.var_85 && this.var_85.productClassId == param1.classId)
         {
            if(this.var_85.roomCategory == this._roomEngine.activeRoomCategory && this.var_85.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_85.category;
               _loc4_ = this.var_85.wallLocation;
               _loc5_ = this.var_85.x;
               _loc6_ = this.var_85.y;
               _loc7_ = this.var_85.direction;
               ...
               if(param1.category == FurniCategory.const_330 || param1.category == FurniCategory.const_298 || param1.category == FurniCategory.const_342)
               {
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_623);
            if(_loc1_ != null)
            {
