package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1778:int = 1;
      
      private const const_1777:int = 2;
      
      private const const_2062:int = 40;
      
      private const const_2061:int = 10;
      
      private var var_775:Array;
      
      private var var_1448:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_514)
         {
            this.var_514.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_514 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_625)
         {
            ...
            this.var_625 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_625)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1777,_loc2_.length);
         if(!this.var_514)
         {
            this.var_514 = new Timer(25);
            this.var_514.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1175 = 0;
         this.populateList();
         this.var_514.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1175 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1175));
            ++this.var_1175;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1778);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_100)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2061;
                  break;
               case "search_input":
                  _loc8_ = this.const_2062;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1448.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_58)
