package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1019:IButtonWindow;
      
      private var var_1018:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1019.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1019 = null;
         }
         if(this.var_1018 != null)
         {
            this.var_1018.removeEventListener(WindowKeyboardEvent.const_171,this.windowKeyEventProcessor);
            this.var_1018 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1019 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1019 != null)
         {
            this.var_1019.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1018 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1018 != null)
         {
            this.var_1018.addEventListener(WindowKeyboardEvent.const_171,this.windowKeyEventProcessor);
         }
         return true;
      }
