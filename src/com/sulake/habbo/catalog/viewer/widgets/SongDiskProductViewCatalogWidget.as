package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_429:IButtonWindow;
      ...
      {
         super(param1);
         this.var_429 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1180 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_429 != null)
         {
            this.var_429.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_429.disable();
         }
         this.var_1179 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_429 != null)
         {
            this.var_429.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_197);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_117);
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_197);
            this._soundManager.musicController.playSong(this.var_967,HabboMusicPrioritiesEnum.const_197,15,40,0.5,2);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1180.text = _loc8_;
            }
         }
         else if(this.var_1180 != null)
         {
            this.var_1180.text = "";
         }
         if(this.var_429 != null)
