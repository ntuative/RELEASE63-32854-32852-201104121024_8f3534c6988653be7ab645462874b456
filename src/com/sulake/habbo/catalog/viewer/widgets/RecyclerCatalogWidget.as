package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_329:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_190)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_190)
         {
      ...
      private function getFurniImageResult(param1:FurniSlotItem) : ImageResult
      {
         ...
         if(param1.category == RoomObjectCategoryEnum.const_25)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_26:
               if(this.var_329 != null)
               {
                  this.var_329.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_329 == null)
               {
                  this.var_329 = new CatalogObjectMover();
                  this.var_329.mainContainer = window;
                  this.var_329.roomEngine = _loc3_;
               }
               this.var_329.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
