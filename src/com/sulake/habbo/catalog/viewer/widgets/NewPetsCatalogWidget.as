package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1395:int = 18;
      ...
      private var var_204:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_100,this.onTextWindowEvent);
         ...
         this.var_530 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_530 < 8)
         {
            return false;
         }
         this.var_2612 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_204 != null && this.var_204.length > 0)
         {
            this.var_376 = this.var_204[0];
         }
         else
         {
            this.var_376 = -1;
         }
         this._offers.add(this.var_530,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_204 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1395 && _loc2_ < this.var_204.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_530,this.var_204[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_204 != null && this.var_204.length > 0)
         {
            if(param1 < 0 || param1 > this.var_204.length)
            {
               param1 = 0;
            }
            this.var_376 = this.var_204[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_530,this.var_376),this.getRaceLocalizationKey(this.var_530,this.var_376));
            }
         }
         return this.getRaceLocalizationKey(this.var_530,this.var_376);
      }
