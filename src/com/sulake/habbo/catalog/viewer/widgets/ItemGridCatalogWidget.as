package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_210:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_848,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_262,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_693,this.deActivateScrollbar);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_213.stop();
            this.var_213.removeEventListener(TimerEvent.TIMER,this.populateItemGrid);
            this.var_213 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_568 = _window.findChildByName("itemGrid") as IItemGridWindow;
         ...
         if(this.var_210)
         {
            this.var_213 = new Timer(25);
            this.var_213.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_213.start();
         }
         return true;
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            if(this.var_761 >= 0 && this.var_761 < page.offers.length)
            {
               _loc3_ = page.offers[this.var_761];
               this.loadGraphics(_loc3_);
               _loc3_.productContainer.grid = this;
            }
            ++this.var_761;
            if(this.var_761 >= page.offers.length)
            {
               this.resetTimer();
               break;
            }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++this.var_1759;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1759);
         }
      }
