package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_195[this.var_479][this.var_705];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_479 = var_568.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_479];
         var _loc3_:Array = this.var_195[this.var_479] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_705 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_705] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_371 || _loc1_.pricingModel == Offer.const_385)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_74 || _loc3_.productType == ProductTypeEnum.const_76)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_195[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
