package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1097:ITextWindow;
      
      private var var_84:IBitmapWrapperWindow;
      
      private var var_1647:Point;
      
      private var var_490:IItemGridWindow;
      
      private var var_1361:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_893 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1097 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1647 = new Point(this.var_84.x,this.var_84.y);
         this.var_490 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1361 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1648 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_893.text = _loc4_;
         this.var_1097.text = _loc5_;
         this.var_893.height = this.var_893.textHeight + 5;
         this.var_1097.y = this.var_893.y + this.var_893.height;
         this.var_1097.height = Math.max(130,this.var_1097.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_470:
                  _loc6_ = this.var_1648.clone();
                  if(this.var_490 != null)
                  {
                     this.var_490.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_490,this.var_1361,this.var_1990);
                     this.var_490.scrollV = 0;
                  }
                  break;
               case Offer.const_371:
                     ...
                     case ProductTypeEnum.const_212:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_319,AvatarAction.const_531);
                              _loc16_.appendAction(AvatarAction.const_321,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2209)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2209 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1647.x;
            this.var_84.y = this.var_1647.y;
            if(param3 != null)
            {
