package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1753:String = "ctlg_";
       
      
      protected var var_1327:XML;
      ...
      private var var_494:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1114:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_494 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1115);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1115);
      }
      ...
      {
         var _loc2_:String = const_1753 + param1;
         ...
         this.var_1327 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1327) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1641:
               if(this.var_1114 == null)
               {
                  this.var_1114 = new ItemGridCatalogWidget(param1);
                  this.var_36.push(this.var_1114);
               }
               break;
            case CatalogWidgetEnum.const_1741:
               this.var_36.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1634:
            ...
            case CatalogWidgetEnum.const_1693:
               ...
               break;
            case CatalogWidgetEnum.const_1499:
            ...
            case CatalogWidgetEnum.const_1668:
               ...
               break;
            case CatalogWidgetEnum.const_1746:
            ...
            case CatalogWidgetEnum.const_1560:
               ...
               break;
            case CatalogWidgetEnum.const_1536:
            ...
            case CatalogWidgetEnum.const_1594:
               ...
               break;
            case CatalogWidgetEnum.const_1745:
            ...
            case CatalogWidgetEnum.const_1587:
               ...
               break;
            case CatalogWidgetEnum.const_1486:
            ...
            case CatalogWidgetEnum.const_1531:
               ...
               break;
            case CatalogWidgetEnum.const_1721:
            ...
            case CatalogWidgetEnum.const_1610:
               ...
               break;
            case CatalogWidgetEnum.const_1570:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_494.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_494 != null)
         {
            return this.var_494.dispatchEvent(param1);
         }
         return false;
      }
