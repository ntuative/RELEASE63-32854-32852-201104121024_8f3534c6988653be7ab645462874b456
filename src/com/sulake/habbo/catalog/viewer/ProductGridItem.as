package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_964:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_247:IItemGrid;
      ...
      {
         this._view.getChildByName(const_964).style = HabboWindowStyle.const_29;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_964).style = 3;
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_247.select(this);
            this.var_595 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_26 && this.var_595 != null && this.var_595 == param2)
         {
            _loc3_ = this.var_247.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_595 = null;
            }
