package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1336:String = "poster";
       
      
      public const const_1957:int = 1;
      
      public const const_1913:int = 2;
      
      public const const_2091:int = 3;
      ...
      private var var_221:MarketplaceConfirmationDialog;
      ...
      private var var_2722:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_320);
            this.var_320 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_221)
         {
            this.var_221 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_221.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2721,this.var_2719,this.var_2562,this.var_2720);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1957,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_320.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_320.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_502)
            {
               this.var_320.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2575 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_320.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1913,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_320.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2375 || param1.furniTypeId != this.var_2381)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         {
            _loc3_ = this._catalog.getFurnitureData(param1.furniId,ProductTypeEnum.const_74);
            if(_loc3_)
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1336)
               {
                  _loc2_ = true;
               }
            }
