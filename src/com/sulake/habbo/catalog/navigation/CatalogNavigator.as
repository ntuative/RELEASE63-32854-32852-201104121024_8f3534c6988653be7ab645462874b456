package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2953:String = "magic.credits";
      
      private var var_2915:String = "magic.pixels";
      
      private var var_2916:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _loc3_.addEventListener(WindowMouseEvent.const_26,this.onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.const_26,this.onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.const_26,this.onNavigatorEvent);
      ...
      {
         this.openPage(this.var_2915);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2916,true);
      }
