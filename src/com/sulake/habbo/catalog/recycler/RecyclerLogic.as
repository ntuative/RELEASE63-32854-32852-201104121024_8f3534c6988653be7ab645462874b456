package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_636 != const_987;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1851 != RecyclerStatusMessageEvent.const_1046;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_636 == const_439;
      }
      ...
      {
         this.var_636 = const_986;
         this.var_118 = new Array(const_190);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_190)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_636 = const_987;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1851)
         {
            case RecyclerStatusMessageEvent.const_1526:
               this.var_636 = const_439;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1046:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1506:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1141:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1647:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_118[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_190)
            {
               oldObjectData = this.var_118[newSlotId];
         ...
         this.var_118[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_118[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_118.length < const_190)
         {
            return false;
         }
         var _loc1_:int = 0;
