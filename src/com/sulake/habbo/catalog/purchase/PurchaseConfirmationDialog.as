package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_93:IPurchasableOffer;
      ...
      private const const_2082:int = 10;
      ...
      private const const_1805:uint = 4.293848814E9;
      
      private const const_1804:uint = 4.294967295E9;
      
      private const const_2083:uint = 4.291613146E9;
      ...
      {
         if(this.var_93 == null || this.var_93.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_93.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_93.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_93 is Offer)
            {
               _loc10_ = this.var_93.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_93 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      {
         var _loc1_:IProductData = this._catalog.getProductData(this.var_93.localizationId);
         ...
         var _loc3_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,this.var_93);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1987 = _loc1_.stuffTypes;
            this.var_835 = _loc1_.boxTypes;
            this.var_834 = _loc1_.ribbonTypes;
            this.var_1264 = this.var_1987[0];
            this.var_389 = this.var_835[0];
            this.var_390 = this.var_834[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_390 < 0)
         {
            this.var_390 = this.var_834.length - 1;
         }
         if(this.var_390 > this.var_834.length - 1)
         {
            this.var_390 = 0;
         }
         if(this.var_389 < 0)
         {
            this.var_389 = this.var_835.length - 1;
         }
         if(this.var_389 > this.var_835.length - 1)
         {
            this.var_389 = 0;
         }
         var _loc1_:int = this.var_835[this.var_389] * 1000 + this.var_834[this.var_390];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_93.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1264,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1540 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1987;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_76);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1264);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_835[this.var_389]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_834[this.var_390]);
         this._catalog.purchaseProductAsGift(this.var_1541,this.var_93,this.var_1539,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1541,this.var_93.offerId,this.var_1539);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_100:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2773 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_234)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_2082)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2773 = _loc3_.text;
               break;
            case WindowMouseEvent.const_43:
               ...
               break;
            case WindowKeyboardEvent.const_380:
      ...
      {
         if(this.var_275 == null || !this.var_275.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_275.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_275 == null)
         {
            this.var_275 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_673 == null)
         {
            this.var_673 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_673.procedure = this.suggestionsEventHandler;
         }
         if(this.var_275 == null || this.var_673 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_275.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_673.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2083;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1805) : uint(this.const_1804);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_275.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1264;
               }
            }
            _loc4_++;
         }
