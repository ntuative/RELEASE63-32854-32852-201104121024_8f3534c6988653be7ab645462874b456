package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_995:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1397:String = "sendAccessTokenToServer";
      
      private static const const_1396:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1397,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1396,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_995);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_995);
         }
      }
