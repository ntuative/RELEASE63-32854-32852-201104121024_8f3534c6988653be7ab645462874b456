package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1760:String = "badge_bg_001_png";
      
      private const const_2030:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1351 = param7;
         this.var_2157 = param5;
         this.var_1627 = param6;
         this.var_59 = param10;
         this._assets = param8;
         this.var_405 = param13;
         ...
         this._window.center();
         this.var_2162 = this.var_59.getBadgeName(this.var_297);
         this.var_2156 = this.var_59.getBadgeDesc(this.var_297);
         this.var_2160 = this.var_59.getAchievementNameForFacebook(this.var_297,this.var_405.userName,this.var_405.realName,this.var_1350);
         this.var_2161 = this.var_59.getAchievementDescForFacebook(this.var_297,this.var_405.userName,this.var_405.realName,this.var_1350);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2158 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_59.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1973.toString());
         this.var_59.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1351.toString());
         this.var_59.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1351.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1627;
         var _loc17_:String = this.var_1627 == 0 ? "pixels" : "activitypoints";
         this.var_59.registerParameter(_loc16_,_loc17_,"" + this.var_2157);
         _loc15_.caption = this.var_59.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1760);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2030) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1351 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_297,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_297,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_297,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_59.registerParameter(param1,"badge_name",this.var_2162);
         this.var_59.registerParameter(param1,"badge_desc",this.var_2156);
         this.var_59.registerParameter(param1,"badge_name_fb",this.var_2160);
         this.var_59.registerParameter(param1,"badge_desc_fb",this.var_2161);
         this.var_59.registerParameter(param1,"level",this.var_1350.toString());
         this.var_59.registerParameter(param1,"name",this.var_405.userName);
         return this.var_59.registerParameter(param1,"realname",this.var_405.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_405.events.removeEventListener(BadgeImageReadyEvent.const_146,this.onBadgeImageReady);
            this.var_405 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_297)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1760);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_297,this._feedTitleFb,this.var_2158,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2159));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_297,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_297,"client.skip_post"));
               this.dispose();
               return;
         }
      }
