package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_915:int = 70;
      
      public static const const_505:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_501:int = 1;
      
      private static const const_1025:int = 2;
      
      private static const const_1026:int = 3;
      
      private static const const_443:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_2028 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_2028 = 15;
         }
         this.var_2027 = this._window.height;
         this.var_846 = 4;
         this.var_847 = 0;
         this._state = name_3;
         this.var_170 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_501:
               ...
               _loc2_ = Number(this.var_1291) / Number(this.var_462["time_fade_in"]);
               if(this.var_1291 > int(this.var_462["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1025:
               ...
               if(this.var_1565 > int(this.var_462["time_display"]) && !this.var_2026)
               {
                  this.startFadeOut();
               }
               break;
            case const_1026:
               ...
               _loc3_ = 1 - Number(this.var_1292) / Number(this.var_462["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1292 > int(this.var_462["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2028;
         if(this._window.height < this.var_2027)
         {
            this._window.height = this.var_2027;
         }
      }
      ...
      {
         this.var_1292 = 0;
         this._state = const_1026;
      }
      
      private function startDisplay() : void
      {
         this.var_1565 = 0;
         this._state = const_1025;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_170.orientation == "TOP" ? int(const_443) : 0;
         var _loc4_:int = this.var_170.orientation == "BOTTOM" ? int(_loc2_.height - const_443) : int(_loc2_.height);
         var _loc5_:int = this.var_170.orientation == "LEFT" ? int(const_443) : 0;
         var _loc6_:int = this.var_170.orientation == "RIGHT" ? int(_loc2_.width - const_443) : int(_loc2_.width);
         if(this.var_462["position_horizontal_follow_toolbar"] == "true" && (this.var_170.orientation != "TOP" && this.var_170.orientation != "BOTTOM"))
         {
            if(this.var_170.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_505;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_505;
            }
         }
         else if(this.var_462["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_505;
         }
         else
         ...
         if(this.var_462["position_vertical_follow_toolbar"] == "true" && (this.var_170.orientation != "RIGHT" && this.var_170.orientation != "LEFT"))
         {
            if(this.var_170.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_846;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_846;
            }
         }
         else if(this.var_462["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_846;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_847;
      }
   }
}
