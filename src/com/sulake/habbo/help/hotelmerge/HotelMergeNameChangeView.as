package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_716)
         {
            this.var_716 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_716)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_715)
         {
            this.var_715 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_715)
            {
               return;
            }
