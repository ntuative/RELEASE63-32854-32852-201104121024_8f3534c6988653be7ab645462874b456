package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1398:int = 30;
      
      private static const const_1352:int = 253;
      
      private static const const_1353:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_198);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1398)
         {
