package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_837:FaqCategory;
      
      private var var_838:FaqCategory;
      ...
      {
         super();
         this.var_836 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_837 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_838 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_837.hasItem(param1))
         {
            this.var_837.getItem(param1).answerText = param2;
         }
         if(this.var_838.hasItem(param1))
         {
            this.var_838.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_837.hasItem(param1))
         {
            return this.var_837.getItem(param1);
         }
         if(this.var_838.hasItem(param1))
         {
            return this.var_838.getItem(param1);
         }
         var _loc2_:int = 0;
