package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_366 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104121018));
         this.var_170 = param5;
         this.var_116 = new Map();
         this.var_116.add(HabboHelpViewEnum.const_1482,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_198,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_578,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_292,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_269,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_414,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_789,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_259,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_116.add(HabboHelpViewEnum.const_1190,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_116.add(HabboHelpViewEnum.const_1169,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_116.add(HabboHelpViewEnum.const_889,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_517.length == 0 || param1 != this.var_366)
            {
               this.var_517.push(this.var_366);
            }
         }
         this.var_366 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_366);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_259:
               this.showUI(HabboHelpViewEnum.const_259);
               break;
            case CallForHelpResultEnum.const_1072:
               this.showUI(HabboHelpViewEnum.const_1169);
               break;
            case CallForHelpResultEnum.const_1066:
               this.showUI(HabboHelpViewEnum.const_1190);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_116.getValue(HabboHelpViewEnum.const_198) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_550));
      }
      ...
      {
         return this.var_116.getValue(this.var_366);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2532 = this._window.width - _loc3_.width;
         this.var_2533 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2533;
         this._window.width = _loc1_.width + this.var_2532;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_517.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_366 == HabboHelpViewEnum.const_198)
         {
            return;
         }
         if(this.var_627.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_627.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_627.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_365.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_627[1],this.var_627[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_627[0],this.var_627[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_366 == HabboHelpViewEnum.const_198 || this.var_517.length == 0)
         {
            return;
         }
         if(this.var_365 == null)
         {
            ...
            this.var_365 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_365.findChildByName("back_image");
            if(_loc3_ != null)
            {
               _loc3_.setParamFlag(WindowParam.const_31);
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBack);
               _loc3_.addEventListener(WindowMouseEvent.const_26,this.onMouseOut);
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOver);
            }
            _loc4_ = this.var_365.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_365 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_365 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_365 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
