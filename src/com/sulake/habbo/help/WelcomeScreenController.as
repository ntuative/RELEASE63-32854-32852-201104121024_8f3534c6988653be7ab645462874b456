package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1363];
      }
      ...
      public function dispose() : void
      {
         if(this.var_131)
         {
            ...
            this.var_131.toolbar.events.removeEventListener(HabboToolbarEvent.const_908,this.onToolbarResized);
            this.var_131 = null;
         }
         ...
         {
            this.var_718.stop();
            this.var_718.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_718 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_131.toolbar.events.addEventListener(HabboToolbarEvent.const_908,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_718 = new Timer(_loc4_);
         this.var_718.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_718.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_224.y = this.var_131.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_224.y;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_286,false);
         _loc4_.height -= 20;
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1363 < this._notifications.length - 1)
         {
            ++this.var_1363;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_224);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_224,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_224.x;
            this._window.y = this.var_224.y;
            this.var_131.removeUpdateReceiver(this);
         }
      }
