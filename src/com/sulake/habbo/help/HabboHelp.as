package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_743:IHabboConfigurationManager;
      
      private var var_405:ISessionDataManager;
      
      private var var_1130:FaqIndex;
      ...
      private var var_742:HotelMergeUI;
      
      private var var_1390:CallForHelpData;
      
      private var var_2299:UserRegistry;
      
      private var var_2250:String = "";
      
      private var var_601:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1390 = new CallForHelpData();
         this.var_2299 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1130 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_743)
         {
            this.var_743.release(new IIDHabboConfigurationManager());
            this.var_743 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_743.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1390.reportedUserId = param1;
         this.var_1390.reportedUserName = param2;
         this.var_66.showUI(HabboHelpViewEnum.const_414);
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            this.var_66 = new HelpUI(this,this._assetLibrary,this._windowManager,this.var_917,this.var_170);
         }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_742)
         {
            this.var_742 = new HotelMergeUI(this);
         }
         this.var_742.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_105)
         {
            this.var_105.showView(TutorialUI.const_299);
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1399 = new IncomingMessages(this,this.var_309);
      ...
      {
         this.var_743 = IHabboConfigurationManager(param2);
      ...
      private function showWelcomeScreen(param1:Boolean) : void
      {
         if(!this.var_601)
         {
            this.var_601 = new WelcomeScreenController(this,this._windowManager,this.var_743);
         }
         this.var_601.showWelcomeScreen(param1);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      public function setWelcomeNotifications(param1:Array) : void
      {
         ...
         this.var_601.notifications = param1;
      }
   }
}
