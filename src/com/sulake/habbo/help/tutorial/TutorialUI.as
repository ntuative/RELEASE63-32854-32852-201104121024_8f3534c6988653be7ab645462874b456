package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_360:String = "TUI_CLOTHES_VIEW";
      
      public static const const_476:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_450,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_303,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1194 && this.var_1193 && this.var_1467;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            ...
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_450,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_303,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_46 == null || this.var_46.id == const_92)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_550:
               this.var_1467 = true;
               if(this.var_46 != null && this.var_46.id == const_476)
               {
                  this.showView(const_92);
               }
               break;
            case HabboHelpTutorialEvent.const_527:
               if(this.var_46 != null && this.var_46.id == const_360)
               {
                  this.var_1845 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2532 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2533;
         this._window.width = _loc2_.width + this.var_2532;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_34.hideUI();
         this.var_34.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_129));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_46 != null && (this.var_46.id == const_299 || this.var_46.id == const_92))
         {
            this.showView(const_92);
         }
      }
      ...
      {
         this.var_1194 = true;
         if(this.var_46 != null && (this.var_46.id == const_360 || this.var_46.id == const_92))
         {
            this.showView(const_92);
         }
      }
