package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1359:uint = 13232628;
      
      private static var var_1642:uint = 11129827;
      ...
      private var var_716:IWindowContainer;
      ...
      {
         return TutorialUI.const_299;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_485 = param1;
         if(this.var_1643 == this.var_485)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1641 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_716)
         {
            this.var_716 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_716)
            {
               return;
            }
            this._window.content.addChild(this.var_716);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_715)
         {
            this.var_715 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_715)
            {
               return;
            }
            this._window.content.addChild(this.var_715);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_715.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_485;
         }
         this.showView(this.var_715);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_485);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_857:
            ...
            case ChangeUserNameResultMessageEvent.var_854:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_859:
               break;
            ...
            case ChangeUserNameResultMessageEvent.var_856:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1057:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.change_not_allowed");
               break;
            case ChangeUserNameResultMessageEvent.var_1059:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1059 || param1 == ChangeUserNameResultMessageEvent.var_1057)
         {
         ...
         while(_loc7_ < _loc5_.numChildren)
         {
            ...
            _loc8_.addEventListener(WindowMouseEvent.const_26,this.nameOut);
            _loc7_++;
         }
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1358)
         {
            if(param1.type == WindowEvent.const_100)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_485 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_485);
               break;
