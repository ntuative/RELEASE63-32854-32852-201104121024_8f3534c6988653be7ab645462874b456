package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1015:int = 100;
      
      private static const const_1426:int = 20;
       
      
      private var var_133:HabboMessenger;
      
      private var var_2749:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_133 = param1;
         this.var_1967 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2749 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_133.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1015 + const_1426)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_133.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1427;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_552 == null || _loc1_.id != this.var_552.id)
         {
            this.var_552 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_552.followingAllowed)
         {
            this.var_1967.enable();
         }
         else
         {
            this.var_1967.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_552.messages.length - const_1015);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_552.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_552.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_133.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_766 || param3.type == Message.const_931 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_552.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_133.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_133.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_133.send(new FollowFriendMessageComposer(this.var_552.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_133.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_931)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1177)
         {
            return 4294927974;
         }
