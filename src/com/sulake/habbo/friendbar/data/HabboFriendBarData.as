package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_616:String = "FriendBar";
      
      private static const const_617:String = "user_interaction";
      
      private static const TRACKING_EVENT_ACTION_VISIT:String = "visit_btn_click";
      
      private static const const_1282:String = "chat_btn_click";
      
      private static const const_1283:String = "find_friends_btn_click";
       
      
      private var var_196:IHabboCommunicationManager;
      
      private var var_886:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_196)
            {
               this.var_196.release(new IIDHabboCommunicationManager());
               this.var_196 = null;
            }
            if(this.var_886)
            {
               this.var_886.release(new IIDHabboMessenger());
               this.var_886 = null;
            }
            this.var_127 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_196)
         {
            this.var_196.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_196.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_616,const_617,TRACKING_EVENT_ACTION_VISIT));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_886)
         {
            this.var_886.startConversation(param1);
            if(this.var_196)
            {
               this.var_196.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_616,const_617,const_1282));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_196)
         {
            this.var_196.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_196.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_616,const_617,const_1283));
         }
      }
      
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_196 = param2 as IHabboCommunicationManager;
         this.var_196.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_196.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_196.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_886 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_127.splice(this.var_127.indexOf(_loc3_),1);
            }
         }
         ...
         {
            this.var_127 = !!const_284 ? this.sortByNameAndOnlineStatus(this.var_127) : this.sortByName(this.var_127);
         }
         events.dispatchEvent(new FriendBarUpdateEvent(FriendBarUpdateEvent.const_571));
      }
