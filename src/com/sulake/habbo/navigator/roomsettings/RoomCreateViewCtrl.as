package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1147:RoomLayout;
      
      private var var_607:Timer;
      
      private var var_1736:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_607 = new Timer(100);
         this.var_607.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_44 = new Array();
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,104,"a"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,94,"b"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,36,"c"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,84,"d"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"e"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,80,"f"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,416,"i"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,320,"j"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,448,"k"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,352,"l"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,384,"m"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_52,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_607)
         {
            this.var_607.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_607.reset();
            this.var_607 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1147.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1736 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1736 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_62 = IItemListWindow(this.var_178.findChildByName("item_list"));
         ...
         this.var_1148 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1148.goBackToInitialState();
         this.var_1148.input.textBackgroundColor = 4294967295;
         this.var_1147 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_69,HabboWindowStyle.const_29,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1148.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1148.getText();
         var _loc3_:String = "model_" + this.var_1147.name;
