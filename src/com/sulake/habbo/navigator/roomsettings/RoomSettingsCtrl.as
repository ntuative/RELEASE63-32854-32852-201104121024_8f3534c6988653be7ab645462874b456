package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_461:IRoomSettingsCtrlOwner;
      ...
      private var var_1283:TextFieldManager;
      ...
      private var var_677:ICheckBoxWindow;
      ...
      private var var_2820:ITextWindow;
      ...
      {
         this.var_391 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_391));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_2007 = true;
         this.var_461.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_391 || this.var_1277 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1277 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1644)
         {
            this.var_844.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1510)
         {
            this.var_844.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1708)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1580)
         {
            this.var_1040.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_844.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_290,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_582,this.onDoorModePasswordUnselect);
         this.method_6().addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSaveButtonClick);
         ...
         this.var_844 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1279 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_1040 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1283 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1282 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1280 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1276 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_677 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2006 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1552 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1278 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1281 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this._switchViewContainer = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1553 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_279 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1275 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2819 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2820 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1554 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1554.mouseThreshold = 0;
         this.var_1554.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1275.visible = false;
         if(!this._inRoom)
         {
      ...
      private function method_6() : IButtonWindow
      {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2006.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2820.visible = this.var_557;
         this.var_2819.visible = !this.var_557;
         if(this.var_557)
         {
            this.var_1281.visible = true;
            this.var_1553.visible = false;
            this.refreshFlatControllers();
            this.var_1281.height = Util.getLowestPoint(this.var_1281) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1278.visible = true;
            this.var_1553.visible = true;
            this.var_1552.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1552.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1278.height = Util.getLowestPoint(this.var_1278) + 4;
         }
         this.var_1554.text = !!this.var_557 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_2006.name,this.var_1552.name,this.var_1278.name,this.var_1281.name,this.var_1553.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_844.setText(_loc1_.name);
         this.var_1279.setText(_loc1_.description);
         this.var_1040.setText("");
         this.var_1283.setText("");
         ...
         if(this.var_1282)
         {
            if(_loc1_.allowPets)
            {
               this.var_1282.select();
            }
            else
            {
               this.var_1282.unselect();
            }
         }
         if(this.var_1280)
         {
         ...
         if(this.var_1276)
         {
            ...
            {
               this.var_1276.select();
            }
            else
            {
               this.var_1276.unselect();
            }
         }
         if(this.var_677)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(this.var_78 == null || this._window == null || this._window.disposed)
         {
            return;
         }
         var _loc2_:SaveableRoomSettingsData = new SaveableRoomSettingsData();
         _loc2_.roomId = this.var_78.roomId;
         _loc2_.name = this.var_844.getText();
         _loc2_.description = this.var_1279.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_507;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_127)
         {
            _loc8_ = this.var_1040.getText();
            _loc9_ = this.var_1283.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1040.clearErrors();
               this.var_1283.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1282.isSelected;
         _loc2_.allowFoodConsume = this.var_1280.isSelected;
         _loc2_.allowWalkThrough = this.var_1276.isSelected;
         _loc2_.hideWalls = this.var_677.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_932,_loc2_.tags);
         this.addTag(this.var_934,_loc2_.tags);
         this.clearErrors();
         this.var_1277 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_391);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_78.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_391]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_69,HabboWindowStyle.const_29,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_391));
      }
      ...
      private function onRemoveFlatCtrlClick(param1:WindowEvent) : void
      {
         ...
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_78.controllers)
         {
            if(_loc3_.selected)
            {
