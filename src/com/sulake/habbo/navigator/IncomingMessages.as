package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1543)
         {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.ROOMINFO));
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_210 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_166,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_256);
      }
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_280).tabPageDecorator);
      ...
      private function onCanCreateRoom(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(this._navigator.sessionData.hasUserRight("fuse_can_create_more_rooms",HabboClubLevelEnum.const_46))
            {
