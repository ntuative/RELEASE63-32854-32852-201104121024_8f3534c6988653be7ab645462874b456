package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_303:MainViewCtrl;
      
      private var var_418:RoomInfoViewCtrl;
      
      private var var_1150:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_427:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2947:Dictionary;
      ...
      private var var_2373:RoomThumbnailRenderer;
      
      private var var_1040:GuestRoomPasswordInput;
      
      private var var_306:GuestRoomDoorbell;
      
      private var var_1149:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2374 = new Array();
         ...
         this.var_303 = new MainViewCtrl(this);
         this.var_418 = new RoomInfoViewCtrl(this);
         this.var_1150 = new RoomCreateViewCtrl(this);
         this.var_2373 = new RoomThumbnailRenderer(this);
         this.var_1040 = new GuestRoomPasswordInput(this);
         this.var_306 = new GuestRoomDoorbell(this);
         this.var_427 = new Tabs(this);
         this.var_1149 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_315,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_418.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_170.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_126,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_418.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_170.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_190.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_303.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_303.startSearch(Tabs.const_254,Tabs.const_423,param1);
         this.var_303.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_303.startSearch(Tabs.const_341,Tabs.const_256);
         this.var_427.getTab(Tabs.const_341).tabPageDecorator.tabSelected();
      }
