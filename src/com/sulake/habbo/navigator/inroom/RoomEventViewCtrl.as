package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_754:TextFieldManager;
      ...
      private var var_1750:IWindowContainer;
      
      private var var_2403:ITextWindow;
      
      private var var_1749:ITextWindow;
      
      private var var_1751:ITextWindow;
      
      private var var_1415:IButtonWindow;
      
      private var var_1417:IButtonWindow;
      
      private var var_2404:IButtonWindow;
      ...
      {
         this.var_933.visible = false;
         this.var_1750.visible = true;
         this.var_2403.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_754.setText(param1.eventDescription);
         ...
         this.var_1416.visible = true;
         this.var_1749.visible = false;
      ...
      {
         var _loc1_:int = this.var_933.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_754.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_932.getText());
         this.addTag(_loc6_,this.var_934.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_754.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1750 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2403 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1749 = ITextWindow(this.find("create_caption"));
            this.var_1751 = ITextWindow(this.find("edit_caption"));
            this.var_1415 = IButtonWindow(this.find("create_button"));
            this.var_1417 = IButtonWindow(this.find("edit_button"));
            this.var_2404 = IButtonWindow(this.find("cancel_button"));
            this.var_1416 = IButtonWindow(this.find("end_button"));
            this.var_933 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1415,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1417,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1416,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2404,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_754 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
