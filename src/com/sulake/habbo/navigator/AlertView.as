package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_597:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_597[this.var_1063] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_1063,2) as IFrameWindow;
